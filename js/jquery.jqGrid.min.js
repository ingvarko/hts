(function(a){a.jgrid=a.jgrid||{};a.extend(a.jgrid,{version:"4.4.1",htmlDecode:function(a){return a&&("&nbsp;"==a||"&#160;"==a||1===a.length&&160===a.charCodeAt(0))?"":!a?a:(""+a).replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/&quot;/g,'"').replace(/&amp;/g,"&")},htmlEncode:function(a){return!a?a:(""+a).replace(/&/g,"&amp;").replace(/\"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},format:function(d){var e=a.makeArray(arguments).slice(1);void 0===d&&(d="");return d.replace(/\{(\d+)\}/g,
...
d.toString().length;p?f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+c+"')")+".substr(0,"+d+") == "+f._getStr('"'+f._toStr(b)+'"')):(d=g?a.trim(b.toString()).length:b.toString().length,f._append(f._getStr("this")+".substr(0,"+d+") == "+f._getStr('"'+f._toStr(c)+'"')));f._setCommand(f.startsWith,c);f._resetNegate();return f};this.endsWith=function(c,b){var d=void 0===b||null===b?c:b,d=g?a.trim(d.toString()).length:d.toString().length;p?f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+c+
"')")+".substr("+f._getStr("jQuery.jgrid.getAccessor(this,'"+c+"')")+".length-"+d+","+d+') == "'+f._toStr(b)+'"'):f._append(f._getStr("this")+".substr("+f._getStr("this")+'.length-"'+f._toStr(c)+'".length,"'+f._toStr(c)+'".length) == "'+f._toStr(c)+'"');f._setCommand(f.endsWith,c);f._resetNegate();return f};this.contains=function(a,c){p?f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+a+"')")+'.indexOf("'+f._toStr(c)+'",0) > -1'):f._append(f._getStr("this")+'.indexOf("'+f._toStr(a)+'",0) > -1');
...
e,d)}this.curGbox=null;document.onselectstart=function(){return!0}},populateVisible:function(){e.timer&&clearTimeout(e.timer);e.timer=null;var c=a(e.bDiv).height();if(c){var d=a("table:first",e.bDiv),g,i;if(d[0].rows.length)try{i=(g=d[0].rows[1])?a(g).outerHeight()||e.prevRowHeight:e.prevRowHeight}catch(l){i=e.prevRowHeight}if(i){e.prevRowHeight=i;var j=b.rowNum;g=e.scrollTop=e.bDiv.scrollTop;var k=Math.round(d.position().top)-g,n=k+d.height();i*=j;var m,o,p;if(n<c&&0>=k&&(void 0===b.lastpage||parseInt((n+
g+i-1)/i,10)<=b.lastpage))o=parseInt((c-n+i-1)/i,10),0<=n||2>o||!0===b.scroll?(m=Math.round((n+g)/i)+1,k=-1):k=1;0<k&&(m=parseInt(g/i,10)+1,o=parseInt((g+c)/i,10)+2-m,p=!0);if(o&&!(b.lastpage&&m>b.lastpage||1==b.lastpage||m===b.page&&m===b.lastpage))e.hDiv.loading?e.timer=setTimeout(e.populateVisible,b.scrollTimeout):(b.page=m,p&&(e.selectionPreserver(d[0]),e.emptyRows.call(d[0],!1,!1)),e.populate(o))}}},scrollGrid:function(a){if(b.scroll){var c=e.bDiv.scrollTop;void 0===e.scrollTop&&(e.scrollTop=
...
"aria-multiselectable":!!this.p.multiselect,"aria-labelledby":"gbox_"+this.id});var o=function(a,c){a=parseInt(a,10);return isNaN(a)?c?c:0:a},l=function(b,d,f,g,i,l){var j=c.p.colModel[b],k=j.align,n='style="',m=j.classes,o=j.name,p=[];k&&(n=n+("text-align:"+k+";"));j.hidden===true&&(n=n+"display:none;");if(d===0)n=n+("width: "+e.headers[b].width+"px;");else if(j.cellattr&&a.isFunction(j.cellattr))if((b=j.cellattr.call(c,i,f,g,j,l))&&typeof b==="string"){b=b.replace(/style/i,"style").replace(/title/i,
"title");if(b.indexOf("title")>-1)j.title=false;b.indexOf("class")>-1&&(m=void 0);p=b.split("style");if(p.length===2){p[1]=a.trim(p[1].replace("=",""));if(p[1].indexOf("'")===0||p[1].indexOf('"')===0)p[1]=p[1].substring(1);n=n+p[1].replace(/'/gi,'"')}else n=n+'"'}if(!p.length){p[0]="";n=n+'"'}n=n+((m!==void 0?' class="'+m+'"':"")+(j.title&&f?' title="'+a.jgrid.stripHtml(f)+'"':""));n=n+(' aria-describedby="'+c.p.id+"_"+o+'"');return n+p[0]},q=function(b){return b===void 0||b===null||b===""?"&#160;":
c.p.autoencode?a.jgrid.htmlEncode(b):b+""},p=function(b,d,e,f,g){var h=c.p.colModel[e];if(typeof h.formatter!=="undefined"){b={rowId:b,colModel:h,gid:c.p.id,pos:e};d=a.isFunction(h.formatter)?h.formatter.call(c,d,b,f,g):a.fmatter?a.fn.fmatter.call(c,h.formatter,d,b,f,g):q(d)}else d=q(d);return d},s=function(a,c,b,d,e){c=p(a,c,b,e,"add");return'<td role="gridcell" '+l(b,d,c,e,a,true)+">"+c+"</td>"},r=function(a,b,d,e){e='<input role="checkbox" type="checkbox" id="jqg_'+c.p.id+"_"+a+'" class="cbox" name="jqg_'+
c.p.id+"_"+a+'"'+(e?'checked="checked"':"")+"/>";return'<td role="gridcell" '+l(b,d,"",null,a,true)+">"+e+"</td>"},t=function(a,c,b,d){b=(parseInt(b,10)-1)*parseInt(d,10)+1+c;return'<td role="gridcell" class="ui-state-default jqgrid-rownum" '+l(a,c,b,null,c,true)+">"+b+"</td>"},v=function(a){var b,d=[],e=0,f;for(f=0;f<c.p.colModel.length;f++){b=c.p.colModel[f];if(b.name!=="cb"&&b.name!=="subgrid"&&b.name!=="rn"){d[e]=a=="local"?b.name:a=="xml"||a==="xmlstring"?b.xmlmap||b.name:b.jsonmap||b.name;e++}}return d},
E=function(b){var d=c.p.remapColumns;if(!d||!d.length)d=a.map(c.p.colModel,function(a,c){return c});b&&(d=a.map(d,function(a){return a<b?null:a-b}));return d},y=function(c,b){var d;if(this.p.deepempty)a(this.rows).slice(1).remove();else{d=this.rows.length>0?this.rows[0]:null;a(this.firstChild).empty().append(d)}if(c&&this.p.scroll){a(this.grid.bDiv.firstChild).css({height:"auto"});a(this.grid.bDiv.firstChild.firstChild).css({height:0,display:"none"});if(this.grid.bDiv.scrollTop!==0)this.grid.bDiv.scrollTop=
0}if(b===true&&this.p.treeGrid){this.p.data=[];this.p._index={}}},x=function(){var b=c.p.data.length,d,e,f;d=c.p.rownumbers===true?1:0;e=c.p.multiselect===true?1:0;f=c.p.subGrid===true?1:0;d=c.p.keyIndex===false||c.p.loadonce===true?c.p.localReader.id:c.p.colModel[c.p.keyIndex+e+f+d].name;for(e=0;e<b;e++){f=a.jgrid.getAccessor(c.p.data[e],d);c.p._index[f]=e}},B=function(b,d,e,f,g,h){var i="-1",j="",l,d=d?"display:none;":"",e="ui-widget-content jqgrow ui-row-"+c.p.direction+e+(h?" ui-state-highlight":
""),f=a.isFunction(c.p.rowattr)?c.p.rowattr.call(c,f,g):{};if(!a.isEmptyObject(f)){if(f.hasOwnProperty("id")){b=f.id;delete f.id}if(f.hasOwnProperty("tabindex")){i=f.tabindex;delete f.tabindex}if(f.hasOwnProperty("style")){d=d+f.style;delete f.style}if(f.hasOwnProperty("class")){e=e+(" "+f["class"]);delete f["class"]}try{delete f.role}catch(k){}for(l in f)f.hasOwnProperty(l)&&(j=j+(" "+l+"="+f[l]))}return'<tr role="row" id="'+b+'" tabindex="'+i+'" class="'+e+'"'+(d===""?"":' style="'+d+'"')+j+">"},
A=function(b,d,e,f,g){var h=new Date,i=c.p.datatype!="local"&&c.p.loadonce||c.p.datatype=="xmlstring",j=c.p.xmlReader,l=c.p.datatype=="local"?"local":"xml";if(i){c.p.data=[];c.p._index={};c.p.localReader.id="_id_"}c.p.reccount=0;if(a.isXMLDoc(b)){if(c.p.treeANode===-1&&!c.p.scroll){y.call(c,false,true);e=1}else e=e>1?e:1;var k,n,m=0,o,p=c.p.multiselect===true?1:0,q=c.p.subGrid===true?1:0,x=c.p.rownumbers===true?1:0,C,u=[],G,z={},A,D,w=[],F=c.p.altRows===true?" "+c.p.altclass:"",P;j.repeatitems||(u=
v(l));C=c.p.keyIndex===false?a.isFunction(j.id)?j.id.call(c,b):j.id:c.p.keyIndex;if(u.length>0&&!isNaN(C)){c.p.remapColumns&&c.p.remapColumns.length&&(C=a.inArray(C,c.p.remapColumns));C=u[C]}l=(C+"").indexOf("[")===-1?u.length?function(c,b){return a(C,c).text()||b}:function(c,b){return a(j.cell,c).eq(C).text()||b}:function(a,c){return a.getAttribute(C.replace(/[\[\]]/g,""))||c};c.p.userData={};c.p.page=a.jgrid.getXmlData(b,j.page)||c.p.page||0;c.p.lastpage=a.jgrid.getXmlData(b,j.total);if(c.p.lastpage===
void 0)c.p.lastpage=1;c.p.records=a.jgrid.getXmlData(b,j.records)||0;a.isFunction(j.userdata)?c.p.userData=j.userdata.call(c,b)||{}:a.jgrid.getXmlData(b,j.userdata,true).each(function(){c.p.userData[this.getAttribute("name")]=a(this).text()});b=a.jgrid.getXmlData(b,j.root,true);(b=a.jgrid.getXmlData(b,j.row,true))||(b=[]);var M=b.length,K=0,O=[],I=parseInt(c.p.rowNum,10);if(M>0&&c.p.page<=0)c.p.page=1;if(b&&M){var H=c.p.scroll?a.jgrid.randId():1;g&&(I=I*(g+1));for(var g=a.isFunction(c.p.afterInsertRow),
ba=c.p.grouping&&c.p.groupingView.groupCollapse===true;K<M;){A=b[K];D=l(A,H+K);D=c.p.idPrefix+D;k=e===0?0:e+1;P=(k+K)%2==1?F:"";var T=w.length;w.push("");x&&w.push(t(0,K,c.p.page,c.p.rowNum));p&&w.push(r(D,x,K,false));q&&w.push(a(c).jqGrid("addSubGridCell",p+x,K+e));if(j.repeatitems){G||(G=E(p+q+x));var N=a.jgrid.getXmlData(A,j.cell,true);a.each(G,function(a){var b=N[this];if(!b)return false;o=b.textContent||b.text;z[c.p.colModel[a+p+q+x].name]=o;w.push(s(D,o,a+p+q+x,K+e,A))})}else for(k=0;k<u.length;k++){o=
a.jgrid.getXmlData(A,u[k]);z[c.p.colModel[k+p+q+x].name]=o;w.push(s(D,o,k+p+q+x,K+e,A))}w[T]=B(D,ba,P,z,A,false);w.push("</tr>");if(c.p.grouping){O=a(c).jqGrid("groupingPrepare",w,O,z,K);w=[]}if(i||c.p.treeGrid===true){z._id_=D;c.p.data.push(z);c.p._index[D]=c.p.data.length-1}if(c.p.gridview===false){a("tbody:first",d).append(w.join(""));a(c).triggerHandler("jqGridAfterInsertRow",[D,z,A]);g&&c.p.afterInsertRow.call(c,D,z,A);w=[]}z={};m++;K++;if(m==I)break}}if(c.p.gridview===true){n=c.p.treeANode>
-1?c.p.treeANode:0;if(c.p.grouping){a(c).jqGrid("groupingRender",O,c.p.colModel.length);O=null}else c.p.treeGrid===true&&n>0?a(c.rows[n]).after(w.join("")):a("tbody:first",d).append(w.join(""))}if(c.p.subGrid===true)try{a(c).jqGrid("addSubGrid",p+x)}catch(J){}c.p.totaltime=new Date-h;if(m>0&&c.p.records===0)c.p.records=M;w=null;if(c.p.treeGrid===true)try{a(c).jqGrid("setTreeNode",n+1,m+n+1)}catch(Q){}if(!c.p.treeGrid&&!c.p.scroll)c.grid.bDiv.scrollTop=0;c.p.reccount=m;c.p.treeANode=-1;c.p.userDataOnFooter&&
a(c).jqGrid("footerData","set",c.p.userData,true);if(i){c.p.records=M;c.p.lastpage=Math.ceil(M/I)}f||c.updatepager(false,true);if(i)for(;m<M;){A=b[m];D=l(A,m+H);D=c.p.idPrefix+D;if(j.repeatitems){G||(G=E(p+q+x));var L=a.jgrid.getXmlData(A,j.cell,true);a.each(G,function(a){var b=L[this];if(!b)return false;o=b.textContent||b.text;z[c.p.colModel[a+p+q+x].name]=o})}else for(k=0;k<u.length;k++){o=a.jgrid.getXmlData(A,u[k]);z[c.p.colModel[k+p+q+x].name]=o}z._id_=D;c.p.data.push(z);c.p._index[D]=c.p.data.length-
1;z={};m++}}},F=function(b,d,e,f,g){d=new Date;if(b){if(c.p.treeANode===-1&&!c.p.scroll){y.call(c,false,true);e=1}else e=e>1?e:1;var h,i,j=c.p.datatype!="local"&&c.p.loadonce||c.p.datatype=="jsonstring";if(j){c.p.data=[];c.p._index={};c.p.localReader.id="_id_"}c.p.reccount=0;if(c.p.datatype=="local"){h=c.p.localReader;i="local"}else{h=c.p.jsonReader;i="json"}var l=0,k,n,m=[],o,p=c.p.multiselect?1:0,q=c.p.subGrid?1:0,x=c.p.rownumbers===true?1:0,C,u,G={},z,w,D=[],A=c.p.altRows===true?" "+c.p.altclass:
"",K;c.p.page=a.jgrid.getAccessor(b,h.page)||c.p.page||0;C=a.jgrid.getAccessor(b,h.total);c.p.lastpage=C===void 0?1:C;c.p.records=a.jgrid.getAccessor(b,h.records)||0;c.p.userData=a.jgrid.getAccessor(b,h.userdata)||{};h.repeatitems||(o=m=v(i));i=c.p.keyIndex===false?a.isFunction(h.id)?h.id.call(c,b):h.id:c.p.keyIndex;if(m.length>0&&!isNaN(i)){c.p.remapColumns&&c.p.remapColumns.length&&(i=a.inArray(i,c.p.remapColumns));i=m[i]}(u=a.jgrid.getAccessor(b,h.root))||(u=[]);C=u.length;b=0;if(C>0&&c.p.page<=
0)c.p.page=1;var F=parseInt(c.p.rowNum,10),M=c.p.scroll?a.jgrid.randId():1,P=false,O;g&&(F=F*(g+1));c.p.datatype==="local"&&!c.p.deselectAfterSort&&(P=true);for(var I=a.isFunction(c.p.afterInsertRow),H=[],ba=c.p.grouping&&c.p.groupingView.groupCollapse===true;b<C;){g=u[b];w=a.jgrid.getAccessor(g,i);if(w===void 0){w=M+b;if(m.length===0&&h.cell){k=a.jgrid.getAccessor(g,h.cell);w=k!==void 0?k[i]||w:w}}w=c.p.idPrefix+w;k=e===1?0:e;K=(k+b)%2==1?A:"";P&&(O=c.p.multiselect?a.inArray(w,c.p.selarrrow)!==-1:
w===c.p.selrow);var T=D.length;D.push("");x&&D.push(t(0,b,c.p.page,c.p.rowNum));p&&D.push(r(w,x,b,O));q&&D.push(a(c).jqGrid("addSubGridCell",p+x,b+e));if(h.repeatitems){h.cell&&(g=a.jgrid.getAccessor(g,h.cell));o||(o=E(p+q+x))}for(n=0;n<o.length;n++){k=a.jgrid.getAccessor(g,o[n]);D.push(s(w,k,n+p+q+x,b+e,g));G[c.p.colModel[n+p+q+x].name]=k}D[T]=B(w,ba,K,G,g,O);D.push("</tr>");if(c.p.grouping){H=a(c).jqGrid("groupingPrepare",D,H,G,b);D=[]}if(j||c.p.treeGrid===true){G._id_=w;c.p.data.push(G);c.p._index[w]=
c.p.data.length-1}if(c.p.gridview===false){a("#"+a.jgrid.jqID(c.p.id)+" tbody:first").append(D.join(""));a(c).triggerHandler("jqGridAfterInsertRow",[w,G,g]);I&&c.p.afterInsertRow.call(c,w,G,g);D=[]}G={};l++;b++;if(l==F)break}if(c.p.gridview===true){z=c.p.treeANode>-1?c.p.treeANode:0;c.p.grouping?a(c).jqGrid("groupingRender",H,c.p.colModel.length):c.p.treeGrid===true&&z>0?a(c.rows[z]).after(D.join("")):a("#"+a.jgrid.jqID(c.p.id)+" tbody:first").append(D.join(""))}if(c.p.subGrid===true)try{a(c).jqGrid("addSubGrid",
p+x)}catch(N){}c.p.totaltime=new Date-d;if(l>0&&c.p.records===0)c.p.records=C;if(c.p.treeGrid===true)try{a(c).jqGrid("setTreeNode",z+1,l+z+1)}catch(J){}if(!c.p.treeGrid&&!c.p.scroll)c.grid.bDiv.scrollTop=0;c.p.reccount=l;c.p.treeANode=-1;c.p.userDataOnFooter&&a(c).jqGrid("footerData","set",c.p.userData,true);if(j){c.p.records=C;c.p.lastpage=Math.ceil(C/F)}f||c.updatepager(false,true);if(j)for(;l<C&&u[l];){g=u[l];w=a.jgrid.getAccessor(g,i);if(w===void 0){w=M+l;m.length===0&&h.cell&&(w=a.jgrid.getAccessor(g,
h.cell)[i]||w)}if(g){w=c.p.idPrefix+w;if(h.repeatitems){h.cell&&(g=a.jgrid.getAccessor(g,h.cell));o||(o=E(p+q+x))}for(n=0;n<o.length;n++){k=a.jgrid.getAccessor(g,o[n]);G[c.p.colModel[n+p+q+x].name]=k}G._id_=w;c.p.data.push(G);c.p._index[w]=c.p.data.length-1;G={}}l++}}},u=function(){function b(d){var e=0,g,h,i,j,l;if(d.groups!==void 0){(h=d.groups.length&&d.groupOp.toString().toUpperCase()==="OR")&&p.orBegin();for(g=0;g<d.groups.length;g++){e>0&&h&&p.or();try{b(d.groups[g])}catch(k){alert(k)}e++}h&&
p.orEnd()}if(d.rules!==void 0){if(e>0){h=p.select();p=a.jgrid.from(h);c.p.ignoreCase&&(p=p.ignoreCase())}try{(i=d.rules.length&&d.groupOp.toString().toUpperCase()==="OR")&&p.orBegin();for(g=0;g<d.rules.length;g++){l=d.rules[g];j=d.groupOp.toString().toUpperCase();if(o[l.op]&&l.field){e>0&&j&&j==="OR"&&(p=p.or());p=o[l.op](p,j)(l.field,l.data,f[l.field])}e++}i&&p.orEnd()}catch(n){alert(n)}}}var d,e=false,f={},g=[],h=[],i,j,l;if(a.isArray(c.p.data)){var k=c.p.grouping?c.p.groupingView:false,n,m;a.each(c.p.colModel,
function(){j=this.sorttype||"text";if(j=="date"||j=="datetime"){if(this.formatter&&typeof this.formatter==="string"&&this.formatter=="date"){i=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:a.jgrid.formatter.date.srcformat;l=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:a.jgrid.formatter.date.newformat}else i=l=this.datefmt||"Y-m-d";f[this.name]={stype:j,srcfmt:i,newfmt:l}}else f[this.name]={stype:j,srcfmt:"",newfmt:""};if(c.p.grouping){m=
0;for(n=k.groupField.length;m<n;m++)if(this.name==k.groupField[m]){var b=this.name;if(typeof this.index!="undefined")b=this.index;g[m]=f[b];h[m]=b}}if(!e&&(this.index==c.p.sortname||this.name==c.p.sortname)){d=this.name;e=true}});if(c.p.treeGrid)a(c).jqGrid("SortTree",d,c.p.sortorder,f[d].stype,f[d].srcfmt);else{var o={eq:function(a){return a.equals},ne:function(a){return a.notEquals},lt:function(a){return a.less},le:function(a){return a.lessOrEquals},gt:function(a){return a.greater},ge:function(a){return a.greaterOrEquals},
cn:function(a){return a.contains},nc:function(a,c){return c==="OR"?a.orNot().contains:a.andNot().contains},bw:function(a){return a.startsWith},bn:function(a,c){return c==="OR"?a.orNot().startsWith:a.andNot().startsWith},en:function(a,c){return c==="OR"?a.orNot().endsWith:a.andNot().endsWith},ew:function(a){return a.endsWith},ni:function(a,c){return c==="OR"?a.orNot().equals:a.andNot().equals},"in":function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,c){return c==="OR"?a.orNot().isNull:
a.andNot().isNull}},p=a.jgrid.from(c.p.data);c.p.ignoreCase&&(p=p.ignoreCase());if(c.p.search===true){var q=c.p.postData.filters;if(q){typeof q=="string"&&(q=a.jgrid.parse(q));b(q)}else try{p=o[c.p.postData.searchOper](p)(c.p.postData.searchField,c.p.postData.searchString,f[c.p.postData.searchField])}catch(s){}}if(c.p.grouping)for(m=0;m<n;m++)p.orderBy(h[m],k.groupOrder[m],g[m].stype,g[m].srcfmt);d&&c.p.sortorder&&e&&(c.p.sortorder.toUpperCase()=="DESC"?p.orderBy(c.p.sortname,"d",f[d].stype,f[d].srcfmt):
p.orderBy(c.p.sortname,"a",f[d].stype,f[d].srcfmt));var q=p.select(),r=parseInt(c.p.rowNum,10),t=q.length,x=parseInt(c.p.page,10),v=Math.ceil(t/r),C={},q=q.slice((x-1)*r,x*r),f=p=null;C[c.p.localReader.total]=v;C[c.p.localReader.page]=x;C[c.p.localReader.records]=t;C[c.p.localReader.root]=q;C[c.p.localReader.userdata]=c.p.userData;q=null;return C}}},H=function(){c.grid.hDiv.loading=true;if(!c.p.hiddengrid)switch(c.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(c.p.id)).show();break;case "block":a("#lui_"+
a.jgrid.jqID(c.p.id)).show();a("#load_"+a.jgrid.jqID(c.p.id)).show()}},N=function(){c.grid.hDiv.loading=false;switch(c.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(c.p.id)).hide();break;case "block":a("#lui_"+a.jgrid.jqID(c.p.id)).hide();a("#load_"+a.jgrid.jqID(c.p.id)).hide()}},Q=function(b){if(!c.grid.hDiv.loading){var d=c.p.scroll&&b===false,e={},f,g=c.p.prmNames;if(c.p.page<=0)c.p.page=1;if(g.search!==null)e[g.search]=c.p.search;g.nd!==null&&(e[g.nd]=(new Date).getTime());if(g.rows!==null)e[g.rows]=
c.p.rowNum;if(g.page!==null)e[g.page]=c.p.page;if(g.sort!==null)e[g.sort]=c.p.sortname;if(g.order!==null)e[g.order]=c.p.sortorder;if(c.p.rowTotal!==null&&g.totalrows!==null)e[g.totalrows]=c.p.rowTotal;var h=a.isFunction(c.p.loadComplete),i=h?c.p.loadComplete:null,j=0,b=b||1;if(b>1)if(g.npage!==null){e[g.npage]=b;j=b-1;b=1}else i=function(a){c.p.page++;c.grid.hDiv.loading=false;h&&c.p.loadComplete.call(c,a);Q(b-1)};else g.npage!==null&&delete c.p.postData[g.npage];if(c.p.grouping){a(c).jqGrid("groupingSetup");
var l=c.p.groupingView,k,n="";for(k=0;k<l.groupField.length;k++){var m=l.groupField[k];a.each(c.p.colModel,function(a,c){if(c.name==m&&c.index)m=c.index});n=n+(m+" "+l.groupOrder[k]+", ")}e[g.sort]=n+e[g.sort]}a.extend(c.p.postData,e);var o=!c.p.scroll?1:c.rows.length-1,e=a(c).triggerHandler("jqGridBeforeRequest");if(!(e===false||e==="stop"))if(a.isFunction(c.p.datatype))c.p.datatype.call(c,c.p.postData,"load_"+c.p.id);else{if(a.isFunction(c.p.beforeRequest)){e=c.p.beforeRequest.call(c);e===void 0&&
(e=true);if(e===false)return}f=c.p.datatype.toLowerCase();switch(f){case "json":case "jsonp":case "xml":case "script":a.ajax(a.extend({url:c.p.url,type:c.p.mtype,dataType:f,data:a.isFunction(c.p.serializeGridData)?c.p.serializeGridData.call(c,c.p.postData):c.p.postData,success:function(e,g,h){if(a.isFunction(c.p.beforeProcessing)&&c.p.beforeProcessing.call(c,e,g,h)===false)N();else{f==="xml"?A(e,c.grid.bDiv,o,b>1,j):F(e,c.grid.bDiv,o,b>1,j);a(c).triggerHandler("jqGridLoadComplete",[e]);i&&i.call(c,
e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);d&&c.grid.populateVisible();if(c.p.loadonce||c.p.treeGrid)c.p.datatype="local";b===1&&N()}},error:function(d,e,f){a.isFunction(c.p.loadError)&&c.p.loadError.call(c,d,e,f);b===1&&N()},beforeSend:function(b,d){var e=true;a.isFunction(c.p.loadBeforeSend)&&(e=c.p.loadBeforeSend.call(c,b,d));e===void 0&&(e=true);if(e===false)return false;H()}},a.jgrid.ajaxOptions,c.p.ajaxGridOptions));break;case "xmlstring":H();e=a.jgrid.stringToDoc(c.p.datastr);A(e,
c.grid.bDiv);a(c).triggerHandler("jqGridLoadComplete",[e]);h&&c.p.loadComplete.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);c.p.datatype="local";c.p.datastr=null;N();break;case "jsonstring":H();e=typeof c.p.datastr=="string"?a.jgrid.parse(c.p.datastr):c.p.datastr;F(e,c.grid.bDiv);a(c).triggerHandler("jqGridLoadComplete",[e]);h&&c.p.loadComplete.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);c.p.datatype="local";c.p.datastr=null;N();break;case "local":case "clientside":H();
c.p.datatype="local";e=u();F(e,c.grid.bDiv,o,b>1,j);a(c).triggerHandler("jqGridLoadComplete",[e]);i&&i.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);d&&c.grid.populateVisible();N()}}}},J=function(b){a("#cb_"+a.jgrid.jqID(c.p.id),c.grid.hDiv)[c.p.useProp?"prop":"attr"]("checked",b);if(c.p.frozenColumns&&c.p.id+"_frozen")a("#cb_"+a.jgrid.jqID(c.p.id),c.grid.fhDiv)[c.p.useProp?"prop":"attr"]("checked",b)};k=function(b,d){var e="",f="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",
g="",h,j,l,k,n=function(b){var d;a.isFunction(c.p.onPaging)&&(d=c.p.onPaging.call(c,b));c.p.selrow=null;if(c.p.multiselect){c.p.selarrrow=[];J(false)}c.p.savedRow=[];return d=="stop"?false:true},b=b.substr(1),d=d+("_"+b);h="pg_"+b;j=b+"_left";l=b+"_center";k=b+"_right";a("#"+a.jgrid.jqID(b)).append("<div id='"+h+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+
j+"' align='left'></td><td id='"+l+"' align='center' style='white-space:pre;'></td><td id='"+k+"' align='right'></td></tr></tbody></table></div>").attr("dir","ltr");if(c.p.rowList.length>0){g="<td dir='"+i+"'>";g=g+"<select class='ui-pg-selbox' role='listbox'>";for(j=0;j<c.p.rowList.length;j++)g=g+('<option role="option" value="'+c.p.rowList[j]+'"'+(c.p.rowNum==c.p.rowList[j]?' selected="selected"':"")+">"+c.p.rowList[j]+"</option>");g=g+"</select></td>"}i=="rtl"&&(f=f+g);c.p.pginput===true&&(e="<td dir='"+
i+"'>"+a.jgrid.format(c.p.pgtext||"","<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>","<span id='sp_1_"+a.jgrid.jqID(b)+"'></span>")+"</td>");if(c.p.pgbuttons===true){j=["first"+d,"prev"+d,"next"+d,"last"+d];i=="rtl"&&j.reverse();f=f+("<td id='"+j[0]+"' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-first'></span></td>");f=f+("<td id='"+j[1]+"' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-prev'></span></td>");
...
c.p.viewrecords===true&&a("td#"+b+"_"+c.p.recordpos,"#"+h).append("<div dir='"+i+"' style='text-align:"+c.p.recordpos+"' class='ui-paging-info'></div>");a("td#"+b+"_"+c.p.pagerpos,"#"+h).append(f);g=a(".ui-jqgrid").css("font-size")||"11px";a(document.body).append("<div id='testpg' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+g+";visibility:hidden;' ></div>");f=a(f).clone().appendTo("#testpg").width();a("#testpg").remove();if(f>0){e!==""&&(f=f+50);a("td#"+b+"_"+c.p.pagerpos,"#"+
h).width(f)}c.p._nvtd=[];c.p._nvtd[0]=f?Math.floor((c.p.width-f)/2):Math.floor(c.p.width/3);c.p._nvtd[1]=0;f=null;a(".ui-pg-selbox","#"+h).bind("change",function(){if(!n("records"))return false;c.p.page=Math.round(c.p.rowNum*(c.p.page-1)/this.value-0.5)+1;c.p.rowNum=this.value;c.p.pager&&a(".ui-pg-selbox",c.p.pager).val(this.value);c.p.toppager&&a(".ui-pg-selbox",c.p.toppager).val(this.value);Q();return false});if(c.p.pgbuttons===true){a(".ui-pg-button","#"+h).hover(function(){if(a(this).hasClass("ui-state-disabled"))this.style.cursor=
"default";else{a(this).addClass("ui-state-hover");this.style.cursor="pointer"}},function(){if(!a(this).hasClass("ui-state-disabled")){a(this).removeClass("ui-state-hover");this.style.cursor="default"}});a("#first"+a.jgrid.jqID(d)+", #prev"+a.jgrid.jqID(d)+", #next"+a.jgrid.jqID(d)+", #last"+a.jgrid.jqID(d)).click(function(){var a=o(c.p.page,1),b=o(c.p.lastpage,1),e=false,f=true,g=true,h=true,i=true;if(b===0||b===1)i=h=g=f=false;else if(b>1&&a>=1)if(a===1)g=f=false;else{if(a===b)i=h=false}else if(b>
1&&a===0){i=h=false;a=b-1}if(!n(this.id))return false;if(this.id==="first"+d&&f){c.p.page=1;e=true}if(this.id==="prev"+d&&g){c.p.page=a-1;e=true}if(this.id==="next"+d&&h){c.p.page=a+1;e=true}if(this.id==="last"+d&&i){c.p.page=b;e=true}e&&Q();return false})}c.p.pginput===true&&a("input.ui-pg-input","#"+h).keypress(function(b){if((b.charCode?b.charCode:b.keyCode?b.keyCode:0)==13){if(!n("user"))return false;c.p.page=a(this).val()>0?a(this).val():c.p.page;Q();return false}return this})};var X=function(b,
d,e,f){if(c.p.colModel[d].sortable&&!(c.p.savedRow.length>0)){if(!e){if(c.p.lastsort==d)if(c.p.sortorder=="asc")c.p.sortorder="desc";else{if(c.p.sortorder=="desc")c.p.sortorder="asc"}else c.p.sortorder=c.p.colModel[d].firstsortorder||"asc";c.p.page=1}if(f){if(c.p.lastsort==d&&c.p.sortorder==f&&!e)return;c.p.sortorder=f}e=c.grid.headers[c.p.lastsort].el;f=c.grid.headers[d].el;a("span.ui-grid-ico-sort",e).addClass("ui-state-disabled");a(e).attr("aria-selected","false");a("span.ui-icon-"+c.p.sortorder,
f).removeClass("ui-state-disabled");a(f).attr("aria-selected","true");if(!c.p.viewsortcols[0]&&c.p.lastsort!=d){a("span.s-ico",e).hide();a("span.s-ico",f).show()}b=b.substring(5+c.p.id.length+1);c.p.sortname=c.p.colModel[d].index||b;e=c.p.sortorder;if(a(c).triggerHandler("jqGridSortCol",[b,d,e])==="stop")c.p.lastsort=d;else if(a.isFunction(c.p.onSortCol)&&c.p.onSortCol.call(c,b,d,e)=="stop")c.p.lastsort=d;else{if(c.p.datatype=="local")c.p.deselectAfterSort&&a(c).jqGrid("resetSelection");else{c.p.selrow=
null;c.p.multiselect&&J(false);c.p.selarrrow=[];c.p.savedRow=[]}if(c.p.scroll){e=c.grid.bDiv.scrollLeft;y.call(c,true,false);c.grid.hDiv.scrollLeft=e}c.p.subGrid&&c.p.datatype=="local"&&a("td.sgexpanded","#"+a.jgrid.jqID(c.p.id)).each(function(){a(this).trigger("click")});Q();c.p.lastsort=d;if(c.p.sortname!=b&&d)c.p.lastsort=d}}},Y=function(b){var d,e={},f=a.jgrid.cellWidth()?0:c.p.cellLayout;for(d=e[0]=e[1]=e[2]=0;d<=b;d++)c.p.colModel[d].hidden===false&&(e[0]=e[0]+(c.p.colModel[d].width+f));c.p.direction==
"rtl"&&(e[0]=c.p.width-e[0]);e[0]=e[0]-c.grid.bDiv.scrollLeft;a(c.grid.cDiv).is(":visible")&&(e[1]=e[1]+(a(c.grid.cDiv).height()+parseInt(a(c.grid.cDiv).css("padding-top"),10)+parseInt(a(c.grid.cDiv).css("padding-bottom"),10)));if(c.p.toolbar[0]===true&&(c.p.toolbar[1]=="top"||c.p.toolbar[1]=="both"))e[1]=e[1]+(a(c.grid.uDiv).height()+parseInt(a(c.grid.uDiv).css("border-top-width"),10)+parseInt(a(c.grid.uDiv).css("border-bottom-width"),10));c.p.toppager&&(e[1]=e[1]+(a(c.grid.topDiv).height()+parseInt(a(c.grid.topDiv).css("border-bottom-width"),
10)));e[2]=e[2]+(a(c.grid.bDiv).height()+a(c.grid.hDiv).height());return e},V=function(b){var d,e=c.grid.headers,f=a.jgrid.getCellIndex(b);for(d=0;d<e.length;d++)if(b===e[d].el){f=d;break}return f};this.p.id=this.id;-1==a.inArray(c.p.multikey,["shiftKey","altKey","ctrlKey"])&&(c.p.multikey=!1);c.p.keyIndex=!1;for(g=0;g<c.p.colModel.length;g++)c.p.colModel[g]=a.extend(!0,{},c.p.cmTemplate,c.p.colModel[g].template||{},c.p.colModel[g]),!1===c.p.keyIndex&&!0===c.p.colModel[g].key&&(c.p.keyIndex=g);c.p.sortorder=
c.p.sortorder.toLowerCase();!0===c.p.grouping&&(c.p.scroll=!1,c.p.rownumbers=!1,c.p.treeGrid=!1,c.p.gridview=!0);if(!0===this.p.treeGrid){try{a(this).jqGrid("setTreeGrid")}catch(W){}"local"!=c.p.datatype&&(c.p.localReader={id:"_id_"})}if(this.p.subGrid)try{a(c).jqGrid("setSubGrid")}catch(aa){}this.p.multiselect&&(this.p.colNames.unshift("<input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox'/>"),this.p.colModel.unshift({name:"cb",width:a.jgrid.cellWidth()?c.p.multiselectWidth+c.p.cellLayout:
...
c.p.jsonReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!0,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},c.p.jsonReader);c.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},c.p.localReader);c.p.scroll&&(c.p.pgbuttons=!1,c.p.pginput=!1,c.p.rowList=[]);c.p.data.length&&x();var L="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",
Z,S,C,G,M,z,w,K;S=K="";if(!0===c.p.shrinkToFit&&!0===c.p.forceFit)for(g=c.p.colModel.length-1;0<=g;g--)if(!c.p.colModel[g].hidden){c.p.colModel[g].resizable=!1;break}"horizontal"==c.p.viewsortcols[1]&&(K=" ui-i-asc",S=" ui-i-desc");Z=m?"class='ui-th-div-ie'":"";K="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+K+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+i+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+S+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+
i+"'></span></span>");for(g=0;g<this.p.colNames.length;g++)S=c.p.headertitles?' title="'+a.jgrid.stripHtml(c.p.colNames[g])+'"':"",L+="<th id='"+c.p.id+"_"+c.p.colModel[g].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+i+"'"+S+">",S=c.p.colModel[g].index||c.p.colModel[g].name,L+="<div id='jqgh_"+c.p.id+"_"+c.p.colModel[g].name+"' "+Z+">"+c.p.colNames[g],c.p.colModel[g].width=c.p.colModel[g].width?parseInt(c.p.colModel[g].width,10):150,"boolean"!==typeof c.p.colModel[g].title&&
(c.p.colModel[g].title=!0),S==c.p.sortname&&(c.p.lastsort=g),L+=K+"</div></th>";K=null;a(this).append(L+"</tr></thead>");a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});if(this.p.multiselect){var O=[],T;a("#cb_"+a.jgrid.jqID(c.p.id),this).bind("click",function(){c.p.selarrrow=[];var b=c.p.frozenColumns===true?c.p.id+"_frozen":"";if(this.checked){a(c.rows).each(function(d){if(d>0&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("jqgroup")&&
!a(this).hasClass("ui-state-disabled")){a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id))[c.p.useProp?"prop":"attr"]("checked",true);a(this).addClass("ui-state-highlight").attr("aria-selected","true");c.p.selarrrow.push(this.id);c.p.selrow=this.id;if(b){a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id),c.grid.fbDiv)[c.p.useProp?"prop":"attr"]("checked",true);a("#"+a.jgrid.jqID(this.id),c.grid.fbDiv).addClass("ui-state-highlight")}}});T=true;O=[]}else{a(c.rows).each(function(d){if(d>
0&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("ui-state-disabled")){a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id))[c.p.useProp?"prop":"attr"]("checked",false);a(this).removeClass("ui-state-highlight").attr("aria-selected","false");O.push(this.id);if(b){a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id),c.grid.fbDiv)[c.p.useProp?"prop":"attr"]("checked",false);a("#"+a.jgrid.jqID(this.id),c.grid.fbDiv).removeClass("ui-state-highlight")}}});c.p.selrow=null;T=false}a(c).triggerHandler("jqGridSelectAll",
[T?c.p.selarrrow:O,T]);a.isFunction(c.p.onSelectAll)&&c.p.onSelectAll.call(c,T?c.p.selarrrow:O,T)})}!0===c.p.autowidth&&(L=a(n).innerWidth(),c.p.width=0<L?L:"nw");(function(){var b=0,d=a.jgrid.cellWidth()?0:o(c.p.cellLayout,0),f=0,g,i=o(c.p.scrollOffset,0),j,l=false,k,n=0,m=0,p;a.each(c.p.colModel,function(){if(typeof this.hidden==="undefined")this.hidden=false;if(c.p.grouping&&c.p.autowidth){var e=a.inArray(this.name,c.p.groupingView.groupField);if(e!==-1)this.hidden=!c.p.groupingView.groupColumnShow[e]}this.widthOrg=
j=o(this.width,0);if(this.hidden===false){b=b+(j+d);this.fixed?n=n+(j+d):f++;m++}});if(isNaN(c.p.width))c.p.width=b+(c.p.shrinkToFit===false&&!isNaN(c.p.height)?i:0);e.width=c.p.width;c.p.tblwidth=b;if(c.p.shrinkToFit===false&&c.p.forceFit===true)c.p.forceFit=false;if(c.p.shrinkToFit===true&&f>0){k=e.width-d*f-n;if(!isNaN(c.p.height)){k=k-i;l=true}b=0;a.each(c.p.colModel,function(a){if(this.hidden===false&&!this.fixed){this.width=j=Math.round(k*this.width/(c.p.tblwidth-d*f-n));b=b+j;g=a}});p=0;l?
e.width-n-(b+d*f)!==i&&(p=e.width-n-(b+d*f)-i):!l&&Math.abs(e.width-n-(b+d*f))!==1&&(p=e.width-n-(b+d*f));c.p.colModel[g].width=c.p.colModel[g].width+p;c.p.tblwidth=b+p+d*f+n;if(c.p.tblwidth>c.p.width){c.p.colModel[g].width=c.p.colModel[g].width-(c.p.tblwidth-parseInt(c.p.width,10));c.p.tblwidth=c.p.width}}})();a(n).css("width",e.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+c.p.id+"'>&#160;</div>");a(j).css("width",e.width+"px");var L=a("thead:first",c).get(0),P="";c.p.footerrow&&
(P+="<table role='grid' style='width:"+c.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+i+"'>");var j=a("tr:first",L),$="<tr class='jqgfirstrow' role='row' style='height:auto'>";c.p.disableClick=!1;a("th",j).each(function(b){C=c.p.colModel[b].width;if(typeof c.p.colModel[b].resizable==="undefined")c.p.colModel[b].resizable=true;if(c.p.colModel[b].resizable){G=document.createElement("span");a(G).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+
i);a.browser.opera||a(G).css("cursor","col-resize");a(this).addClass(c.p.resizeclass)}else G="";a(this).css("width",C+"px").prepend(G);var d="";if(c.p.colModel[b].hidden){a(this).css("display","none");d="display:none;"}$=$+("<td role='gridcell' style='height:0px;width:"+C+"px;"+d+"'></td>");e.headers[b]={width:C,el:this};M=c.p.colModel[b].sortable;if(typeof M!=="boolean")M=c.p.colModel[b].sortable=true;d=c.p.colModel[b].name;d=="cb"||d=="subgrid"||d=="rn"||c.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");
if(M)if(c.p.viewsortcols[0]){a("div span.s-ico",this).show();b==c.p.lastsort&&a("div span.ui-icon-"+c.p.sortorder,this).removeClass("ui-state-disabled")}else if(b==c.p.lastsort){a("div span.s-ico",this).show();a("div span.ui-icon-"+c.p.sortorder,this).removeClass("ui-state-disabled")}c.p.footerrow&&(P=P+("<td role='gridcell' "+l(b,0,"",null,"",false)+">&#160;</td>"))}).mousedown(function(b){if(a(b.target).closest("th>span.ui-jqgrid-resize").length==1){var d=V(this);if(c.p.forceFit===true){var f=c.p,
g=d,i;for(i=d+1;i<c.p.colModel.length;i++)if(c.p.colModel[i].hidden!==true){g=i;break}f.nv=g-d}e.dragStart(d,b,Y(d));return false}}).click(function(b){if(c.p.disableClick)return c.p.disableClick=false;var d="th>div.ui-jqgrid-sortable",e,f;c.p.viewsortcols[2]||(d="th>div>span>span.ui-grid-ico-sort");b=a(b.target).closest(d);if(b.length==1){d=V(this);if(!c.p.viewsortcols[2]){e=true;f=b.attr("sort")}X(a("div",this)[0].id,d,e,f);return false}});if(c.p.sortable&&a.fn.sortable)try{a(c).jqGrid("sortableColumns",
j)}catch(ba){}c.p.footerrow&&(P+="</tr></tbody></table>");$+="</tr>";this.appendChild(document.createElement("tbody"));a(this).addClass("ui-jqgrid-btable").append($);var $=null,j=a("<table class='ui-jqgrid-htable' style='width:"+c.p.tblwidth+"px' role='grid' aria-labelledby='gbox_"+this.id+"' cellspacing='0' cellpadding='0' border='0'></table>").append(L),R=c.p.caption&&!0===c.p.hiddengrid?!0:!1;g=a("<div class='ui-jqgrid-hbox"+("rtl"==i?"-rtl":"")+"'></div>");L=null;e.hDiv=document.createElement("div");
a(e.hDiv).css({width:e.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(g);a(g).append(j);j=null;R&&a(e.hDiv).hide();c.p.pager&&("string"==typeof c.p.pager?"#"!=c.p.pager.substr(0,1)&&(c.p.pager="#"+c.p.pager):c.p.pager="#"+a(c.p.pager).attr("id"),a(c.p.pager).css({width:e.width+"px"}).appendTo(n).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom"),R&&a(c.p.pager).hide(),k(c.p.pager,""));!1===c.p.cellEdit&&!0===c.p.hoverrows&&a(c).bind("mouseover",function(b){w=a(b.target).closest("tr.jqgrow");
a(w).attr("class")!=="ui-subgrid"&&a(w).addClass("ui-state-hover")}).bind("mouseout",function(b){w=a(b.target).closest("tr.jqgrow");a(w).removeClass("ui-state-hover")});var I,U,ca;a(c).before(e.hDiv).click(function(b){z=b.target;w=a(z,c.rows).closest("tr.jqgrow");if(a(w).length===0||w[0].className.indexOf("ui-state-disabled")>-1||(a(z,c).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==c.id)return this;var d=a(z).hasClass("cbox"),e=a(c).triggerHandler("jqGridBeforeSelectRow",
[w[0].id,b]);(e=e===false||e==="stop"?false:true)&&a.isFunction(c.p.beforeSelectRow)&&(e=c.p.beforeSelectRow.call(c,w[0].id,b));if(!(z.tagName=="A"||(z.tagName=="INPUT"||z.tagName=="TEXTAREA"||z.tagName=="OPTION"||z.tagName=="SELECT")&&!d)&&e===true){I=w[0].id;U=a.jgrid.getCellIndex(z);ca=a(z).closest("td,th").html();a(c).triggerHandler("jqGridCellSelect",[I,U,ca,b]);a.isFunction(c.p.onCellSelect)&&c.p.onCellSelect.call(c,I,U,ca,b);if(c.p.cellEdit===true)if(c.p.multiselect&&d)a(c).jqGrid("setSelection",
I,true,b);else{I=w[0].rowIndex;try{a(c).jqGrid("editCell",I,U,true)}catch(f){}}else if(c.p.multikey)if(b[c.p.multikey])a(c).jqGrid("setSelection",I,true,b);else{if(c.p.multiselect&&d){d=a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+I).is(":checked");a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+I)[c.p.useProp?"prop":"attr"]("checked",d)}}else{if(c.p.multiselect&&c.p.multiboxonly&&!d){var g=c.p.frozenColumns?c.p.id+"_frozen":"";a(c.p.selarrrow).each(function(b,d){var e=c.rows.namedItem(d);a(e).removeClass("ui-state-highlight");
a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(d))[c.p.useProp?"prop":"attr"]("checked",false);if(g){a("#"+a.jgrid.jqID(d),"#"+a.jgrid.jqID(g)).removeClass("ui-state-highlight");a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(d),"#"+a.jgrid.jqID(g))[c.p.useProp?"prop":"attr"]("checked",false)}});c.p.selarrrow=[]}a(c).jqGrid("setSelection",I,true,b)}}}).bind("reloadGrid",function(b,d){if(c.p.treeGrid===true)c.p.datatype=c.p.treedatatype;d&&d.current&&c.grid.selectionPreserver(c);if(c.p.datatype==
"local"){a(c).jqGrid("resetSelection");c.p.data.length&&x()}else if(!c.p.treeGrid){c.p.selrow=null;if(c.p.multiselect){c.p.selarrrow=[];J(false)}c.p.savedRow=[]}c.p.scroll&&y.call(c,true,false);if(d&&d.page){var e=d.page;if(e>c.p.lastpage)e=c.p.lastpage;e<1&&(e=1);c.p.page=e;c.grid.bDiv.scrollTop=c.grid.prevRowHeight?(e-1)*c.grid.prevRowHeight*c.p.rowNum:0}if(c.grid.prevRowHeight&&c.p.scroll){delete c.p.lastpage;c.grid.populateVisible()}else c.grid.populate();c.p._inlinenav===true&&a(c).jqGrid("showAddEditButtons");
return false}).dblclick(function(b){z=b.target;w=a(z,c.rows).closest("tr.jqgrow");if(a(w).length!==0){I=w[0].rowIndex;U=a.jgrid.getCellIndex(z);a(c).triggerHandler("jqGridDblClickRow",[a(w).attr("id"),I,U,b]);a.isFunction(this.p.ondblClickRow)&&c.p.ondblClickRow.call(c,a(w).attr("id"),I,U,b)}}).bind("contextmenu",function(b){z=b.target;w=a(z,c.rows).closest("tr.jqgrow");if(a(w).length!==0){c.p.multiselect||a(c).jqGrid("setSelection",w[0].id,true,b);I=w[0].rowIndex;U=a.jgrid.getCellIndex(z);a(c).triggerHandler("jqGridRightClickRow",
[a(w).attr("id"),I,U,b]);a.isFunction(this.p.onRightClickRow)&&c.p.onRightClickRow.call(c,a(w).attr("id"),I,U,b)}});e.bDiv=document.createElement("div");m&&"auto"===(""+c.p.height).toLowerCase()&&(c.p.height="100%");a(e.bDiv).append(a('<div style="position:relative;'+(m&&8>a.browser.version?"height:0.01%;":"")+'"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:c.p.height+(isNaN(c.p.height)?"":"px"),width:e.width+"px"}).scroll(e.scrollGrid);a("table:first",e.bDiv).css({width:c.p.tblwidth+
"px"});m?(2==a("tbody",this).length&&a("tbody:gt(0)",this).remove(),c.p.multikey&&a(e.bDiv).bind("selectstart",function(){return false})):c.p.multikey&&a(e.bDiv).bind("mousedown",function(){return false});R&&a(e.bDiv).hide();e.cDiv=document.createElement("div");var da=!0===c.p.hidegrid?a("<a role='link' href='javascript:void(0)'/>").addClass("ui-jqgrid-titlebar-close HeaderButton").hover(function(){da.addClass("ui-state-hover")},function(){da.removeClass("ui-state-hover")}).append("<span class='ui-icon ui-icon-circle-triangle-n'></span>").css("rtl"==
i?"left":"right","0px"):"";a(e.cDiv).append(da).append("<span class='ui-jqgrid-title"+("rtl"==i?"-rtl":"")+"'>"+c.p.caption+"</span>").addClass("ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix");a(e.cDiv).insertBefore(e.hDiv);c.p.toolbar[0]&&(e.uDiv=document.createElement("div"),"top"==c.p.toolbar[1]?a(e.uDiv).insertBefore(e.hDiv):"bottom"==c.p.toolbar[1]&&a(e.uDiv).insertAfter(e.hDiv),"both"==c.p.toolbar[1]?(e.ubDiv=document.createElement("div"),a(e.uDiv).insertBefore(e.hDiv).addClass("ui-userdata ui-state-default").attr("id",
"t_"+this.id),a(e.ubDiv).insertAfter(e.hDiv).addClass("ui-userdata ui-state-default").attr("id","tb_"+this.id),R&&a(e.ubDiv).hide()):a(e.uDiv).width(e.width).addClass("ui-userdata ui-state-default").attr("id","t_"+this.id),R&&a(e.uDiv).hide());c.p.toppager&&(c.p.toppager=a.jgrid.jqID(c.p.id)+"_toppager",e.topDiv=a("<div id='"+c.p.toppager+"'></div>")[0],c.p.toppager="#"+c.p.toppager,a(e.topDiv).insertBefore(e.hDiv).addClass("ui-state-default ui-jqgrid-toppager").width(e.width),k(c.p.toppager,"_t"));
c.p.footerrow&&(e.sDiv=a("<div class='ui-jqgrid-sdiv'></div>")[0],g=a("<div class='ui-jqgrid-hbox"+("rtl"==i?"-rtl":"")+"'></div>"),a(e.sDiv).append(g).insertAfter(e.hDiv).width(e.width),a(g).append(P),e.footers=a(".ui-jqgrid-ftable",e.sDiv)[0].rows[0].cells,c.p.rownumbers&&(e.footers[0].className="ui-state-default jqgrid-rownum"),R&&a(e.sDiv).hide());g=null;if(c.p.caption){var ea=c.p.datatype;!0===c.p.hidegrid&&(a(".ui-jqgrid-titlebar-close",e.cDiv).click(function(b){var d=a.isFunction(c.p.onHeaderClick),
f=".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv",g,i=this;if(c.p.toolbar[0]===true){c.p.toolbar[1]=="both"&&(f=f+(", #"+a(e.ubDiv).attr("id")));f=f+(", #"+a(e.uDiv).attr("id"))}g=a(f,"#gview_"+a.jgrid.jqID(c.p.id)).length;c.p.gridstate=="visible"?a(f,"#gbox_"+a.jgrid.jqID(c.p.id)).slideUp("fast",function(){g--;if(g===0){a("span",i).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s");c.p.gridstate="hidden";a("#gbox_"+a.jgrid.jqID(c.p.id)).hasClass("ui-resizable")&&
a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(c.p.id)).hide();a(c).triggerHandler("jqGridHeaderClick",[c.p.gridstate,b]);d&&(R||c.p.onHeaderClick.call(c,c.p.gridstate,b))}}):c.p.gridstate=="hidden"&&a(f,"#gbox_"+a.jgrid.jqID(c.p.id)).slideDown("fast",function(){g--;if(g===0){a("span",i).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n");if(R){c.p.datatype=ea;Q();R=false}c.p.gridstate="visible";a("#gbox_"+a.jgrid.jqID(c.p.id)).hasClass("ui-resizable")&&a(".ui-resizable-handle",
"#gbox_"+a.jgrid.jqID(c.p.id)).show();a(c).triggerHandler("jqGridHeaderClick",[c.p.gridstate,b]);d&&(R||c.p.onHeaderClick.call(c,c.p.gridstate,b))}});return false}),R&&(c.p.datatype="local",a(".ui-jqgrid-titlebar-close",e.cDiv).trigger("click")))}else a(e.cDiv).hide();a(e.hDiv).after(e.bDiv).mousemove(function(a){if(e.resizing){e.dragMove(a);return false}});a(".ui-jqgrid-labels",e.hDiv).bind("selectstart",function(){return false});a(document).mouseup(function(){if(e.resizing){e.dragEnd();return false}return true});
c.formatCol=l;c.sortData=X;c.updatepager=function(b,d){var e,f,g,h,i,j,l,k="",n=c.p.pager?"_"+a.jgrid.jqID(c.p.pager.substr(1)):"",m=c.p.toppager?"_"+c.p.toppager.substr(1):"";g=parseInt(c.p.page,10)-1;g<0&&(g=0);g=g*parseInt(c.p.rowNum,10);i=g+c.p.reccount;if(c.p.scroll){e=a("tbody:first > tr:gt(0)",c.grid.bDiv);g=i-e.length;c.p.reccount=e.length;if(f=e.outerHeight()||c.grid.prevRowHeight){e=g*f;f=parseInt(c.p.records,10)*f;a(">div:first",c.grid.bDiv).css({height:f}).children("div:first").css({height:e,
display:e?"":"none"})}c.grid.bDiv.scrollLeft=c.grid.hDiv.scrollLeft}k=c.p.pager?c.p.pager:"";if(k=k+(c.p.toppager?k?","+c.p.toppager:c.p.toppager:"")){l=a.jgrid.formatter.integer||{};e=o(c.p.page);f=o(c.p.lastpage);a(".selbox",k)[this.p.useProp?"prop":"attr"]("disabled",false);if(c.p.pginput===true){a(".ui-pg-input",k).val(c.p.page);h=c.p.toppager?"#sp_1"+n+",#sp_1"+m:"#sp_1"+n;a(h).html(a.fmatter?a.fmatter.util.NumberFormat(c.p.lastpage,l):c.p.lastpage)}if(c.p.viewrecords)if(c.p.reccount===0)a(".ui-paging-info",
...
n).removeClass("ui-state-disabled");c.p.toppager&&a("#first_t"+m+", #prev_t"+m).removeClass("ui-state-disabled")}if(e==f||e===0){a("#next"+n+", #last"+n).addClass("ui-state-disabled").removeClass("ui-state-hover");c.p.toppager&&a("#next_t"+m+", #last_t"+m).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{a("#next"+n+", #last"+n).removeClass("ui-state-disabled");c.p.toppager&&a("#next_t"+m+", #last_t"+m).removeClass("ui-state-disabled")}}}b===true&&c.p.rownumbers===true&&a("td.jqgrid-rownum",
c.rows).each(function(b){a(this).html(g+1+b)});d&&c.p.jqgdnd&&a(c).jqGrid("gridDnD","updateDnD");a(c).triggerHandler("jqGridGridComplete");a.isFunction(c.p.gridComplete)&&c.p.gridComplete.call(c);a(c).triggerHandler("jqGridAfterGridComplete")};c.refreshIndex=x;c.setHeadCheckBox=J;c.constructTr=B;c.formatter=function(a,b,c,d,e){return p(a,b,c,d,e)};a.extend(e,{populate:Q,emptyRows:y});this.grid=e;c.addXmlData=function(a){A(a,c.grid.bDiv)};c.addJSONData=function(a){F(a,c.grid.bDiv)};this.grid.cols=
this.rows[0].cells;Q();c.p.hiddengrid=!1}}}})};a.jgrid.extend({getGridParam:function(a){var e=this[0];return!e||!e.grid?void 0:a?"undefined"!=typeof e.p[a]?e.p[a]:null:e.p},setGridParam:function(d){return this.each(function(){this.grid&&"object"===typeof d&&a.extend(!0,this.p,d)})},getDataIDs:function(){var d=[],e=0,b,f=0;this.each(function(){if((b=this.rows.length)&&0<b)for(;e<b;)a(this.rows[e]).hasClass("jqgrow")&&(d[f]=this.rows[e].id,f++),e++});return d},setSelection:function(d,e,b){return this.each(function(){var f,
c,h,g,i,j;if(void 0!==d&&(e=!1===e?!1:!0,(c=this.rows.namedItem(d+""))&&c.className&&!(-1<c.className.indexOf("ui-state-disabled"))))(!0===this.p.scrollrows&&(h=this.rows.namedItem(d).rowIndex,0<=h&&(f=a(this.grid.bDiv)[0].clientHeight,g=a(this.grid.bDiv)[0].scrollTop,i=a(this.rows[h]).position().top,h=this.rows[h].clientHeight,i+h>=f+g?a(this.grid.bDiv)[0].scrollTop=i-(f+g)+h+g:i<f+g&&i<g&&(a(this.grid.bDiv)[0].scrollTop=i))),!0===this.p.frozenColumns&&(j=this.p.id+"_frozen"),this.p.multiselect)?
...
a.unformat.date.call(g,e[f],this):e[f],i=g.formatter(d,e[f],b,e,"edit"),h=this.title?{title:a.jgrid.stripHtml(i)}:{},!0===g.p.treeGrid&&f==g.p.ExpandColumn?a("td[role='gridcell']:eq("+b+") > span:first",j).html(i).attr(h):a("td[role='gridcell']:eq("+b+")",j).html(i).attr(h))}),"local"==g.p.datatype){var n=a.jgrid.stripPref(g.p.idPrefix,d),o=g.p._index[n];if(g.p.treeGrid)for(var l in g.p.treeReader)m.hasOwnProperty(g.p.treeReader[l])&&delete m[g.p.treeReader[l]];"undefined"!=typeof o&&(g.p.data[o]=
a.extend(!0,g.p.data[o],m));m=null}}catch(q){c=!1}c&&("string"===k?a(j).addClass(b):"object"===k&&a(j).css(b),a(g).triggerHandler("jqGridAfterGridComplete"))});return c},addRowData:function(d,e,b,f){b||(b="last");var c=!1,h,g,i,j,k,m,n,o,l="",q,p,s,r,t,v;e&&(a.isArray(e)?(q=!0,b="last",p=d):(e=[e],q=!1),this.each(function(){var E=e.length;k=this.p.rownumbers===true?1:0;i=this.p.multiselect===true?1:0;j=this.p.subGrid===true?1:0;if(!q)if(typeof d!="undefined")d=d+"";else{d=a.jgrid.randId();if(this.p.keyIndex!==
false){p=this.p.colModel[this.p.keyIndex+i+j+k].name;typeof e[0][p]!="undefined"&&(d=e[0][p])}}s=this.p.altclass;for(var y=0,x="",B={},A=a.isFunction(this.p.afterInsertRow)?true:false;y<E;){r=e[y];g=[];if(q){try{d=r[p]}catch(F){d=a.jgrid.randId()}x=this.p.altRows===true?(this.rows.length-1)%2===0?s:"":""}v=d;d=this.p.idPrefix+d;if(k){l=this.formatCol(0,1,"",null,d,true);g[g.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+l+">0</td>"}if(i){o='<input role="checkbox" type="checkbox" id="jqg_'+
this.p.id+"_"+d+'" class="cbox"/>';l=this.formatCol(k,1,"",null,d,true);g[g.length]='<td role="gridcell" '+l+">"+o+"</td>"}j&&(g[g.length]=a(this).jqGrid("addSubGridCell",i+k,1));for(n=i+j+k;n<this.p.colModel.length;n++){t=this.p.colModel[n];h=t.name;B[h]=r[h];o=this.formatter(d,a.jgrid.getAccessor(r,h),n,r);l=this.formatCol(n,1,o,r,d,true);g[g.length]='<td role="gridcell" '+l+">"+o+"</td>"}g.unshift(this.constructTr(d,false,x,B,r,false));g[g.length]="</tr>";if(this.rows.length===0)a("table:first",
this.grid.bDiv).append(g.join(""));else switch(b){case "last":a(this.rows[this.rows.length-1]).after(g.join(""));m=this.rows.length-1;break;case "first":a(this.rows[0]).after(g.join(""));m=1;break;case "after":(m=this.rows.namedItem(f))&&(a(this.rows[m.rowIndex+1]).hasClass("ui-subgrid")?a(this.rows[m.rowIndex+1]).after(g):a(m).after(g.join("")));m++;break;case "before":if(m=this.rows.namedItem(f)){a(m).before(g.join(""));m=m.rowIndex}m--}this.p.subGrid===true&&a(this).jqGrid("addSubGrid",i+k,m);
this.p.records++;this.p.reccount++;a(this).triggerHandler("jqGridAfterInsertRow",[d,r,r]);A&&this.p.afterInsertRow.call(this,d,r,r);y++;if(this.p.datatype=="local"){B[this.p.localReader.id]=v;this.p._index[v]=this.p.data.length;this.p.data.push(B);B={}}}this.p.altRows===true&&!q&&(b=="last"?(this.rows.length-1)%2==1&&a(this.rows[this.rows.length-1]).addClass(s):a(this.rows).each(function(b){b%2==1?a(this).addClass(s):a(this).removeClass(s)}));this.updatepager(true,true);c=true}));return c},footerData:function(d,
e,b){function f(a){for(var b in a)if(a.hasOwnProperty(b))return!1;return!0}var c,h=!1,g={},i;"undefined"==typeof d&&(d="get");"boolean"!=typeof b&&(b=!0);d=d.toLowerCase();this.each(function(){var j=this,k;if(!j.grid||!j.p.footerrow||"set"==d&&f(e))return!1;h=!0;a(this.p.colModel).each(function(f){c=this.name;"set"==d?void 0!==e[c]&&(k=b?j.formatter("",e[c],f,e,"edit"):e[c],i=this.title?{title:a.jgrid.stripHtml(k)}:{},a("tr.footrow td:eq("+f+")",j.grid.sDiv).html(k).attr(i),h=!0):"get"==d&&(g[c]=
a("tr.footrow td:eq("+f+")",j.grid.sDiv).html())})});return"get"==d?g:h},showHideCol:function(d,e){return this.each(function(){var b=this,f=!1,c=a.jgrid.cellWidth()?0:b.p.cellLayout,h;if(b.grid){"string"===typeof d&&(d=[d]);e="none"!=e?"":"none";var g=""===e?!0:!1,i=b.p.groupHeader&&("object"===typeof b.p.groupHeader||a.isFunction(b.p.groupHeader));i&&a(b).jqGrid("destroyGroupHeader",!1);a(this.p.colModel).each(function(i){if(-1!==a.inArray(this.name,d)&&this.hidden===g){if(!0===b.p.frozenColumns&&
...
d));a(h).triggerHandler("jqGridRemapColumns",[d,e,b])},setGridWidth:function(d,e){return this.each(function(){if(this.grid){var b=this,f,c=0,h=a.jgrid.cellWidth()?0:b.p.cellLayout,g,i=0,j=!1,k=b.p.scrollOffset,m,n=0,o=0,l;"boolean"!=typeof e&&(e=b.p.shrinkToFit);if(!isNaN(d)){d=parseInt(d,10);b.grid.width=b.p.width=d;a("#gbox_"+a.jgrid.jqID(b.p.id)).css("width",d+"px");a("#gview_"+a.jgrid.jqID(b.p.id)).css("width",d+"px");a(b.grid.bDiv).css("width",d+"px");a(b.grid.hDiv).css("width",d+"px");b.p.pager&&
a(b.p.pager).css("width",d+"px");b.p.toppager&&a(b.p.toppager).css("width",d+"px");!0===b.p.toolbar[0]&&(a(b.grid.uDiv).css("width",d+"px"),"both"==b.p.toolbar[1]&&a(b.grid.ubDiv).css("width",d+"px"));b.p.footerrow&&a(b.grid.sDiv).css("width",d+"px");!1===e&&!0===b.p.forceFit&&(b.p.forceFit=!1);if(!0===e){a.each(b.p.colModel,function(){if(this.hidden===false){f=this.widthOrg;c=c+(f+h);this.fixed?n=n+(f+h):i++;o++}});if(0===i)return;b.p.tblwidth=c;m=d-h*i-n;if(!isNaN(b.p.height)&&(a(b.grid.bDiv)[0].clientHeight<
a(b.grid.bDiv)[0].scrollHeight||1===b.rows.length))j=!0,m-=k;var c=0,q=0<b.grid.cols.length;a.each(b.p.colModel,function(a){if(this.hidden===false&&!this.fixed){f=this.widthOrg;f=Math.round(m*f/(b.p.tblwidth-h*i-n));if(!(f<0)){this.width=f;c=c+f;b.grid.headers[a].width=f;b.grid.headers[a].el.style.width=f+"px";if(b.p.footerrow)b.grid.footers[a].style.width=f+"px";if(q)b.grid.cols[a].style.width=f+"px";g=a}}});if(!g)return;l=0;j?d-n-(c+h*i)!==k&&(l=d-n-(c+h*i)-k):1!==Math.abs(d-n-(c+h*i))&&(l=d-n-
(c+h*i));b.p.colModel[g].width+=l;b.p.tblwidth=c+l+h*i+n;b.p.tblwidth>d?(j=b.p.tblwidth-parseInt(d,10),b.p.tblwidth=d,f=b.p.colModel[g].width-=j):f=b.p.colModel[g].width;b.grid.headers[g].width=f;b.grid.headers[g].el.style.width=f+"px";q&&(b.grid.cols[g].style.width=f+"px");b.p.footerrow&&(b.grid.footers[g].style.width=f+"px")}b.p.tblwidth&&(a("table:first",b.grid.bDiv).css("width",b.p.tblwidth+"px"),a("table:first",b.grid.hDiv).css("width",b.p.tblwidth+"px"),b.grid.hDiv.scrollLeft=b.grid.bDiv.scrollLeft,
b.p.footerrow&&a("table:first",b.grid.sDiv).css("width",b.p.tblwidth+"px"))}}})},setGridHeight:function(d){return this.each(function(){if(this.grid){var e=a(this.grid.bDiv);e.css({height:d+(isNaN(d)?"":"px")});!0===this.p.frozenColumns&&a("#"+a.jgrid.jqID(this.p.id)+"_frozen").parent().height(e.height()-16);this.p.height=d;this.p.scroll&&this.grid.populateVisible()}})},setCaption:function(d){return this.each(function(){this.p.caption=d;a("span.ui-jqgrid-title, span.ui-jqgrid-title-rtl",this.grid.cDiv).html(d);
a(this.grid.cDiv).show()})},setLabel:function(d,e,b,f){return this.each(function(){var c=-1;if(this.grid&&"undefined"!=typeof d&&(a(this.p.colModel).each(function(a){if(this.name==d)return c=a,!1}),0<=c)){var h=a("tr.ui-jqgrid-labels th:eq("+c+")",this.grid.hDiv);if(e){var g=a(".s-ico",h);a("[id^=jqgh_]",h).empty().html(e).append(g);this.p.colNames[c]=e}b&&("string"===typeof b?a(h).addClass(b):a(h).css(b));"object"===typeof f&&a(h).attr(f)}})},setCell:function(d,e,b,f,c,h){return this.each(function(){var g=
-1,i,j;if(this.grid&&(isNaN(e)?a(this.p.colModel).each(function(a){if(this.name==e)return g=a,!1}):g=parseInt(e,10),0<=g&&(i=this.rows.namedItem(d)))){var k=a("td:eq("+g+")",i);if(""!==b||!0===h)i=this.formatter(d,b,g,i,"edit"),j=this.p.colModel[g].title?{title:a.jgrid.stripHtml(i)}:{},this.p.treeGrid&&0<a(".tree-wrap",a(k)).length?a("span",a(k)).html(i).attr(j):a(k).html(i).attr(j),"local"==this.p.datatype&&(i=this.p.colModel[g],b=i.formatter&&"string"===typeof i.formatter&&"date"==i.formatter?a.unformat.date.call(this,
b,i):b,j=this.p._index[d],"undefined"!=typeof j&&(this.p.data[j][i.name]=b));"string"===typeof f?a(k).addClass(f):f&&a(k).css(f);"object"===typeof c&&a(k).attr(c)}})},getCell:function(d,e){var b=!1;this.each(function(){var f=-1;if(this.grid&&(isNaN(e)?a(this.p.colModel).each(function(a){if(this.name===e)return f=a,!1}):f=parseInt(e,10),0<=f)){var c=this.rows.namedItem(d);if(c)try{b=a.unformat.call(this,a("td:eq("+f+")",c),{rowId:c.id,colModel:this.p.colModel[f]},f)}catch(h){b=a.jgrid.htmlDecode(a("td:eq("+
f+")",c).html())}}});return b},getCol:function(d,e,b){var f=[],c,h=0,g,i,j,e="boolean"!=typeof e?!1:e;"undefined"==typeof b&&(b=!1);this.each(function(){var k=-1;if(this.grid&&(isNaN(d)?a(this.p.colModel).each(function(a){if(this.name===d)return k=a,!1}):k=parseInt(d,10),0<=k)){var m=this.rows.length,n=0;if(m&&0<m){for(;n<m;){if(a(this.rows[n]).hasClass("jqgrow")){try{c=a.unformat.call(this,a(this.rows[n].cells[k]),{rowId:this.rows[n].id,colModel:this.p.colModel[k]},k)}catch(o){c=a.jgrid.htmlDecode(this.rows[n].cells[k].innerHTML)}b?
(j=parseFloat(c),h+=j,void 0===i&&(i=g=j),g=Math.min(g,j),i=Math.max(i,j)):e?f.push({id:this.rows[n].id,value:c}):f.push(c)}n++}if(b)switch(b.toLowerCase()){case "sum":f=h;break;case "avg":f=h/m;break;case "count":f=m;break;case "min":f=g;break;case "max":f=i}}}});return f},clearGridData:function(d){return this.each(function(){if(this.grid){"boolean"!=typeof d&&(d=!1);if(this.p.deepempty)a("#"+a.jgrid.jqID(this.p.id)+" tbody:first tr:gt(0)").remove();else{var e=a("#"+a.jgrid.jqID(this.p.id)+" tbody:first tr:first")[0];
a("#"+a.jgrid.jqID(this.p.id)+" tbody:first").empty().append(e)}this.p.footerrow&&d&&a(".ui-jqgrid-ftable td",this.grid.sDiv).html("&#160;");this.p.selrow=null;this.p.selarrrow=[];this.p.savedRow=[];this.p.records=0;this.p.page=1;this.p.lastpage=0;this.p.reccount=0;this.p.data=[];this.p._index={};this.updatepager(!0,!1)}})},getInd:function(a,e){var b=!1,f;this.each(function(){(f=this.rows.namedItem(a))&&(b=!0===e?f:f.rowIndex)});return b},bindKeys:function(d){var e=a.extend({onEnter:null,onSpace:null,
onLeftKey:null,onRightKey:null,scrollingRows:!0},d||{});return this.each(function(){var b=this;a("body").is("[role]")||a("body").attr("role","application");b.p.scrollrows=e.scrollingRows;a(b).keydown(function(d){var c=a(b).find("tr[tabindex=0]")[0],h,g,i,j=b.p.treeReader.expanded_field;if(c)if(i=b.p._index[c.id],37===d.keyCode||38===d.keyCode||39===d.keyCode||40===d.keyCode){if(38===d.keyCode){g=c.previousSibling;h="";if(g)if(a(g).is(":hidden"))for(;g;){if(g=g.previousSibling,!a(g).is(":hidden")&&
a(g).hasClass("jqgrow")){h=g.id;break}}else h=g.id;a(b).jqGrid("setSelection",h,!0,d);d.preventDefault()}if(40===d.keyCode){g=c.nextSibling;h="";if(g)if(a(g).is(":hidden"))for(;g;){if(g=g.nextSibling,!a(g).is(":hidden")&&a(g).hasClass("jqgrow")){h=g.id;break}}else h=g.id;a(b).jqGrid("setSelection",h,!0,d);d.preventDefault()}37===d.keyCode&&(b.p.treeGrid&&b.p.data[i][j]&&a(c).find("div.treeclick").trigger("click"),a(b).triggerHandler("jqGridKeyLeft",[b.p.selrow]),a.isFunction(e.onLeftKey)&&e.onLeftKey.call(b,
b.p.selrow));39===d.keyCode&&(b.p.treeGrid&&!b.p.data[i][j]&&a(c).find("div.treeclick").trigger("click"),a(b).triggerHandler("jqGridKeyRight",[b.p.selrow]),a.isFunction(e.onRightKey)&&e.onRightKey.call(b,b.p.selrow))}else 13===d.keyCode?(a(b).triggerHandler("jqGridKeyEnter",[b.p.selrow]),a.isFunction(e.onEnter)&&e.onEnter.call(b,b.p.selrow)):32===d.keyCode&&(a(b).triggerHandler("jqGridKeySpace",[b.p.selrow]),a.isFunction(e.onSpace)&&e.onSpace.call(b,b.p.selrow))})})},unbindKeys:function(){return this.each(function(){a(this).unbind("keydown")})},
...
a.jgrid.jqID(this.p.id)).slideDown("fast"),a(".ui-jqgrid-titlebar-close span",this.grid.cDiv).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n"),this.p.gridstate="visible"))})},filterToolbar:function(d){d=a.extend({autosearch:!0,searchOnEnter:!0,beforeSearch:null,afterSearch:null,beforeClear:null,afterClear:null,searchurl:"",stringResult:!1,groupOp:"AND",defaultSearch:"bw"},d||{});return this.each(function(){function e(b,c){var d=a(b);d[0]&&jQuery.each(c,function(){void 0!==
this.data?d.bind(this.type,this.data,this.fn):d.bind(this.type,this.fn)})}var b=this;if(!this.ftoolbar){var f=function(){var c={},e=0,f,h,m={},n;a.each(b.p.colModel,function(){h=this.index||this.name;n=this.searchoptions&&this.searchoptions.sopt?this.searchoptions.sopt[0]:"select"==this.stype?"eq":d.defaultSearch;if(f=a("#gs_"+a.jgrid.jqID(this.name),!0===this.frozen&&!0===b.p.frozenColumns?b.grid.fhDiv:b.grid.hDiv).val())c[h]=f,m[h]=n,e++;else try{delete b.p.postData[h]}catch(l){}});var o=0<e?!0:
!1;if(!0===d.stringResult||"local"==b.p.datatype){var l='{"groupOp":"'+d.groupOp+'","rules":[',q=0;a.each(c,function(a,b){0<q&&(l+=",");l+='{"field":"'+a+'",';l+='"op":"'+m[a]+'",';l+='"data":"'+(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}';q++});l+="]}";a.extend(b.p.postData,{filters:l});a.each(["searchField","searchString","searchOper"],function(a,c){b.p.postData.hasOwnProperty(c)&&delete b.p.postData[c]})}else a.extend(b.p.postData,c);var p;b.p.searchurl&&(p=b.p.url,a(b).jqGrid("setGridParam",
{url:b.p.searchurl}));var s="stop"===a(b).triggerHandler("jqGridToolbarBeforeSearch")?!0:!1;!s&&a.isFunction(d.beforeSearch)&&(s=d.beforeSearch.call(b));s||a(b).jqGrid("setGridParam",{search:o}).trigger("reloadGrid",[{page:1}]);p&&a(b).jqGrid("setGridParam",{url:p});a(b).triggerHandler("jqGridToolbarAfterSearch");a.isFunction(d.afterSearch)&&d.afterSearch.call(b)},c=a("<tr class='ui-search-toolbar' role='rowheader'></tr>"),h;a.each(b.p.colModel,function(){var g=this,i,j,k,m;j=a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"+
b.p.direction+"'></th>");i=a("<div style='width:100%;position:relative;height:100%;padding-right:0.3em;'></div>");!0===this.hidden&&a(j).css("display","none");this.search=!1===this.search?!1:!0;"undefined"==typeof this.stype&&(this.stype="text");k=a.extend({},this.searchoptions||{});if(this.search)switch(this.stype){case "select":if(m=this.surl||k.dataUrl)a.ajax(a.extend({url:m,dataType:"html",success:function(b){if(k.buildSelect!==void 0)(b=k.buildSelect(b))&&a(i).append(b);else a(i).append(b);k.defaultValue!==
void 0&&a("select",i).val(k.defaultValue);a("select",i).attr({name:g.index||g.name,id:"gs_"+g.name});k.attr&&a("select",i).attr(k.attr);a("select",i).css({width:"100%"});k.dataInit!==void 0&&k.dataInit(a("select",i)[0]);k.dataEvents!==void 0&&e(a("select",i)[0],k.dataEvents);d.autosearch===true&&a("select",i).change(function(){f();return false});b=null}},a.jgrid.ajaxOptions,b.p.ajaxSelectOptions||{}));else{var n,o,l;g.searchoptions?(n=void 0===g.searchoptions.value?"":g.searchoptions.value,o=void 0===
g.searchoptions.separator?":":g.searchoptions.separator,l=void 0===g.searchoptions.delimiter?";":g.searchoptions.delimiter):g.editoptions&&(n=void 0===g.editoptions.value?"":g.editoptions.value,o=void 0===g.editoptions.separator?":":g.editoptions.separator,l=void 0===g.editoptions.delimiter?";":g.editoptions.delimiter);if(n){m=document.createElement("select");m.style.width="100%";a(m).attr({name:g.index||g.name,id:"gs_"+g.name});var q;if("string"===typeof n){n=n.split(l);for(var p=0;p<n.length;p++)q=
n[p].split(o),l=document.createElement("option"),l.value=q[0],l.innerHTML=q[1],m.appendChild(l)}else if("object"===typeof n)for(q in n)n.hasOwnProperty(q)&&(l=document.createElement("option"),l.value=q,l.innerHTML=n[q],m.appendChild(l));void 0!==k.defaultValue&&a(m).val(k.defaultValue);k.attr&&a(m).attr(k.attr);void 0!==k.dataInit&&k.dataInit(m);void 0!==k.dataEvents&&e(m,k.dataEvents);a(i).append(m);!0===d.autosearch&&a(m).change(function(){f();return false})}}break;case "text":o=void 0!==k.defaultValue?
k.defaultValue:"",a(i).append("<input type='text' style='width:95%;padding:0px;' name='"+(g.index||g.name)+"' id='gs_"+g.name+"' value='"+o+"'/>"),k.attr&&a("input",i).attr(k.attr),void 0!==k.dataInit&&k.dataInit(a("input",i)[0]),void 0!==k.dataEvents&&e(a("input",i)[0],k.dataEvents),!0===d.autosearch&&(d.searchOnEnter?a("input",i).keypress(function(a){if((a.charCode?a.charCode:a.keyCode?a.keyCode:0)==13){f();return false}return this}):a("input",i).keydown(function(a){switch(a.which){case 13:return false;
...
d.grid.fbDiv=a('<div style="position:absolute;left:0px;top:'+(parseInt(e,10)+parseInt(b,10)+1)+'px;overflow-y:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>');a("#gview_"+a.jgrid.jqID(d.p.id)).append(d.grid.fhDiv);e=a(".ui-jqgrid-htable","#gview_"+a.jgrid.jqID(d.p.id)).clone(!0);if(d.p.groupHeader){a("tr.jqg-first-row-header, tr.jqg-third-row-header",e).each(function(){a("th:gt("+c+")",this).remove()});var g=-1,i=-1;a("tr.jqg-second-row-header th",e).each(function(){var b=parseInt(a(this).attr("colspan"),
10);b&&(g+=b,i++);if(g===c)return!1});g!==c&&(i=c);a("tr.jqg-second-row-header",e).each(function(){a("th:gt("+i+")",this).remove()})}else a("tr",e).each(function(){a("th:gt("+c+")",this).remove()});a(e).width(1);a(d.grid.fhDiv).append(e).mousemove(function(a){if(d.grid.resizing)return d.grid.dragMove(a),!1});a(d).bind("jqGridResizeStop.setFrozenColumns",function(b,c,e){b=a(".ui-jqgrid-htable",d.grid.fhDiv);a("th:eq("+e+")",b).width(c);b=a(".ui-jqgrid-btable",d.grid.fbDiv);a("tr:first td:eq("+e+")",
b).width(c)});a(d).bind("jqGridOnSortCol.setFrozenColumns",function(b,c){var e=a("tr.ui-jqgrid-labels:last th:eq("+d.p.lastsort+")",d.grid.fhDiv),f=a("tr.ui-jqgrid-labels:last th:eq("+c+")",d.grid.fhDiv);a("span.ui-grid-ico-sort",e).addClass("ui-state-disabled");a(e).attr("aria-selected","false");a("span.ui-icon-"+d.p.sortorder,f).removeClass("ui-state-disabled");a(f).attr("aria-selected","true");!d.p.viewsortcols[0]&&d.p.lastsort!=c&&(a("span.s-ico",e).hide(),a("span.s-ico",f).show())});a("#gview_"+
a.jgrid.jqID(d.p.id)).append(d.grid.fbDiv);jQuery(d.grid.bDiv).scroll(function(){jQuery(d.grid.fbDiv).scrollTop(jQuery(this).scrollTop())});!0===d.p.hoverrows&&a("#"+a.jgrid.jqID(d.p.id)).unbind("mouseover").unbind("mouseout");a(d).bind("jqGridAfterGridComplete.setFrozenColumns",function(){a("#"+a.jgrid.jqID(d.p.id)+"_frozen").remove();jQuery(d.grid.fbDiv).height(jQuery(d.grid.bDiv).height()-16);var b=a("#"+a.jgrid.jqID(d.p.id)).clone(!0);a("tr",b).each(function(){a("td:gt("+c+")",this).remove()});
a(b).width(1).attr("id",d.p.id+"_frozen");a(d.grid.fbDiv).append(b);!0===d.p.hoverrows&&(a("tr.jqgrow",b).hover(function(){a(this).addClass("ui-state-hover");a("#"+a.jgrid.jqID(this.id),"#"+a.jgrid.jqID(d.p.id)).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover");a("#"+a.jgrid.jqID(this.id),"#"+a.jgrid.jqID(d.p.id)).removeClass("ui-state-hover")}),a("tr.jqgrow","#"+a.jgrid.jqID(d.p.id)).hover(function(){a(this).addClass("ui-state-hover");a("#"+a.jgrid.jqID(this.id),"#"+a.jgrid.jqID(d.p.id)+
...
function(a){return k(this,a,"jqmShow")};a.fn.jqmShow=function(b){return this.each(function(){a.jqm.open(this._jqm,b)})};a.fn.jqmHide=function(b){return this.each(function(){a.jqm.close(this._jqm,b)})};a.jqm={hash:{},open:function(d,g){var j=e[d],l=j.c,k="."+l.closeClass,p=parseInt(j.w.css("z-index")),p=0<p?p:3E3,s=a("<div></div>").css({height:"100%",width:"100%",position:"fixed",left:0,top:0,"z-index":p-1,opacity:l.overlay/100});if(j.a)return c;j.t=g;j.a=!0;j.w.css("z-index",p);l.modal?(b[0]||setTimeout(function(){i("bind")},
1),b.push(d)):0<l.overlay?l.closeoverlay&&j.w.jqmAddClose(s):s=c;j.o=s?s.addClass(l.overlayClass).prependTo("body"):c;if(f&&(a("html,body").css({height:"100%",width:"100%"}),s)){var s=s.css({position:"absolute"})[0],r;for(r in{Top:1,Left:1})s.style.setExpression(r.toLowerCase(),"(_=(document.documentElement.scroll"+r+" || document.body.scroll"+r+"))+'px'")}l.ajax?(p=l.target||j.w,s=l.ajax,p="string"==typeof p?a(p,j.w):a(p),s="@"==s.substr(0,1)?a(g).attr(s.substring(1)):s,p.html(l.ajaxText).load(s,
function(){l.onLoad&&l.onLoad.call(this,j);k&&j.w.jqmAddClose(a(k,j.w));h(j)})):k&&j.w.jqmAddClose(a(k,j.w));l.toTop&&j.o&&j.w.before('<span id="jqmP'+j.w[0]._jqm+'"></span>').insertAfter(j.o);l.onShow?l.onShow(j):j.w.show();h(j);return c},close:function(d){d=e[d];if(!d.a)return c;d.a=c;b[0]&&(b.pop(),b[0]||i("unbind"));d.c.toTop&&d.o&&a("#jqmP"+d.w[0]._jqm).after(d.w).remove();if(d.c.onHide)d.c.onHide(d);else d.w.hide(),d.o&&d.o.remove();return c},params:{}};var d=0,e=a.jqm.hash,b=[],f=a.browser.msie&&
...
"0.3em"));var o=document.createElement("div");a(o).addClass("ui-jqdialog-content ui-widget-content").attr("id",d.modalcontent);a(o).append(e);i.appendChild(o);a(i).prepend(m);!0===h?a("body").append(i):"string"==typeof h?a(h).append(i):a(i).insertBefore(f);a(i).css(g);"undefined"===typeof b.jqModal&&(b.jqModal=!0);e={};if(a.fn.jqm&&!0===b.jqModal)0===b.left&&0===b.top&&b.overlay&&(g=[],g=a.jgrid.findPos(c),b.left=g[0]+4,b.top=g[1]+4),e.top=b.top+"px",e.left=b.left;else if(0!==b.left||0!==b.top)e.left=
...
"option");if(a.inArray(a.trim(a(this).text()),c)>-1||a.inArray(a.trim(a(this).val()),c)>-1)this.selected="selected"})},0)}}},c||{}));else if(e.value){var k;"undefined"===typeof e.size&&(e.size=d?3:1);d&&(f=b.split(","),f=a.map(f,function(b){return a.trim(b)}));"function"===typeof e.value&&(e.value=e.value());var m,n,o=void 0===e.separator?":":e.separator,c=void 0===e.delimiter?";":e.delimiter;if("string"===typeof e.value){m=e.value.split(c);for(k=0;k<m.length;k++){n=m[k].split(o);2<n.length&&(n[1]=
a.map(n,function(a,b){if(b>0)return a}).join(o));c=document.createElement("option");c.setAttribute("role","option");c.value=n[0];c.innerHTML=n[1];i.appendChild(c);if(!d&&(a.trim(n[0])==a.trim(b)||a.trim(n[1])==a.trim(b)))c.selected="selected";if(d&&(-1<a.inArray(a.trim(n[1]),f)||-1<a.inArray(a.trim(n[0]),f)))c.selected="selected"}}else if("object"===typeof e.value)for(k in o=e.value,o)if(o.hasOwnProperty(k)){c=document.createElement("option");c.setAttribute("role","option");c.value=k;c.innerHTML=
o[k];i.appendChild(c);if(!d&&(a.trim(k)==a.trim(b)||a.trim(o[k])==a.trim(b)))c.selected="selected";if(d&&(-1<a.inArray(a.trim(o[k]),f)||-1<a.inArray(a.trim(k),f)))c.selected="selected"}g(i,e,["value"]);e=h(i,e)}break;case "text":case "password":case "button":k="button"==d?"button":"textbox";i=document.createElement("input");i.type=d;i.value=b;g(i,e);e=h(i,e);"button"!=d&&(f?e.size||a(i).css({width:"98%"}):e.size||(e.size=20));a(i).attr("role",k);break;case "image":case "file":i=document.createElement("input");
i.type=d;g(i,e);e=h(i,e);break;case "custom":i=document.createElement("span");try{if(a.isFunction(e.custom_element))if(o=e.custom_element.call(j,b,e))o=a(o).addClass("customelement").attr({id:e.id,name:e.name}),a(i).empty().append(o);else throw"e2";else throw"e1";}catch(l){"e1"==l&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"==l?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,
...
b)),h.append(i);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)g.append(this.createTableRowForRule(b.rules[e],b));return g};this.createTableRowForRule=function(b,c){var d=this,e=a("<tr></tr>"),g,h,j,s,r="",t;e.append("<td class='first'></td>");var v=a("<td class='columns'></td>");e.append(v);var E=a("<select></select>"),y,x=[];v.append(E);E.bind("change",function(){b.field=a(E).val();j=a(this).parents("tr:first");for(g=0;g<d.p.columns.length;g++)if(d.p.columns[g].name===
b.field){s=d.p.columns[g];break}if(s){s.searchoptions.id=a.jgrid.randId();i&&"text"===s.inputtype&&!s.searchoptions.size&&(s.searchoptions.size=10);var c=a.jgrid.createEl(s.inputtype,s.searchoptions,"",!0,d.p.ajaxSelectOptions,!0);a(c).addClass("input-elm");h=s.searchoptions.sopt?s.searchoptions.sopt:d.p.sopt?d.p.sopt:"string"===s.searchtype?d.p.stropts:d.p.numopts;var e="",f=0;x=[];a.each(d.p.ops,function(){x.push(this.name)});for(g=0;g<h.length;g++)y=a.inArray(h[g],x),-1!==y&&(0===f&&(b.op=d.p.ops[y].name),
e+="<option value='"+d.p.ops[y].name+"'>"+d.p.ops[y].description+"</option>",f++);a(".selectopts",j).empty().append(e);a(".selectopts",j)[0].selectedIndex=0;a.browser.msie&&9>a.browser.version&&(e=parseInt(a("select.selectopts",j)[0].offsetWidth)+1,a(".selectopts",j).width(e),a(".selectopts",j).css("width","auto"));a(".data",j).empty().append(c);a(".input-elm",j).bind("change",function(c){var e=a(this).hasClass("ui-autocomplete-input")?200:0;setTimeout(function(){var e=c.target;b.data=e.nodeName.toUpperCase()===
"SPAN"&&s.searchoptions&&a.isFunction(s.searchoptions.custom_value)?s.searchoptions.custom_value(a(e).children(".customelement:first"),"get"):e.value;d.onchange()},e)});setTimeout(function(){b.data=a(c).val();d.onchange()},0)}});for(g=v=0;g<d.p.columns.length;g++){t="undefined"===typeof d.p.columns[g].search?!0:d.p.columns[g].search;var B=!0===d.p.columns[g].hidden;if(!0===d.p.columns[g].searchoptions.searchhidden&&t||t&&!B)t="",b.field===d.p.columns[g].name&&(t=" selected='selected'",v=g),r+="<option value='"+
d.p.columns[g].name+"'"+t+">"+d.p.columns[g].label+"</option>"}E.append(r);r=a("<td class='operators'></td>");e.append(r);s=f.columns[v];s.searchoptions.id=a.jgrid.randId();i&&"text"===s.inputtype&&!s.searchoptions.size&&(s.searchoptions.size=10);var v=a.jgrid.createEl(s.inputtype,s.searchoptions,b.data,!0,d.p.ajaxSelectOptions,!0),A=a("<select class='selectopts'></select>");r.append(A);A.bind("change",function(){b.op=a(A).val();j=a(this).parents("tr:first");var c=a(".input-elm",j)[0];if(b.op==="nu"||
b.op==="nn"){b.data="";c.value="";c.setAttribute("readonly","true");c.setAttribute("disabled","true")}else{c.removeAttribute("readonly");c.removeAttribute("disabled")}d.onchange()});h=s.searchoptions.sopt?s.searchoptions.sopt:d.p.sopt?d.p.sopt:"string"===s.searchtype?f.stropts:d.p.numopts;r="";a.each(d.p.ops,function(){x.push(this.name)});for(g=0;g<h.length;g++)y=a.inArray(h[g],x),-1!==y&&(t=b.op===d.p.ops[y].name?" selected='selected'":"",r+="<option value='"+d.p.ops[y].name+"'"+t+">"+d.p.ops[y].description+
"</option>");A.append(r);r=a("<td class='data'></td>");e.append(r);r.append(v);a(v).addClass("input-elm").bind("change",function(){b.data=s.inputtype==="custom"?s.searchoptions.custom_value(a(this).children(".customelement:first"),"get"):a(this).val();d.onchange()});r=a("<td></td>");e.append(r);!0===this.p.ruleButtons&&(v=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),r.append(v),v.bind("click",function(){for(g=0;g<c.rules.length;g++)if(c.rules[g]===b){c.rules.splice(g,
...
modal:d.modal,overlay:d.overlay,toTop:d.toTop}),a(f).triggerHandler("jqGridFilterAfterShow",[b]),a.isFunction(d.afterShowSearch)&&d.afterShowSearch.call(f,b))}var f=this;if(f.grid){var c="fbox_"+f.p.id,h=!0,g={themodal:"searchmod"+c,modalhead:"searchhd"+c,modalcontent:"searchcnt"+c,scrollelm:c},i=f.p.postData[d.sFilter];"string"===typeof i&&(i=a.jgrid.parse(i));!0===d.recreateFilter&&a("#"+a.jgrid.jqID(g.themodal)).remove();if(void 0!==a("#"+a.jgrid.jqID(g.themodal))[0])b(a("#fbox_"+a.jgrid.jqID(+f.p.id)));
else{var j=a("<div><div id='"+c+"' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_"+a.jgrid.jqID(f.p.id)),k="left",m="";"rtl"==f.p.direction&&(k="right",m=" style='text-align:left'",j.attr("dir","rtl"));var n=a.extend([],f.p.colModel),o="<a href='javascript:void(0)' id='"+c+"_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>"+d.Find+"</a>",l="<a href='javascript:void(0)' id='"+c+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+
d.Reset+"</a>",q="",p="",s,r=!1,t=-1;d.showQuery&&(q="<a href='javascript:void(0)' id='"+c+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");d.columns.length?n=d.columns:a.each(n,function(a,b){if(!b.label)b.label=f.p.colNames[a];if(!r){var d=typeof b.search==="undefined"?true:b.search,c=b.hidden===true;if(b.searchoptions&&b.searchoptions.searchhidden===true&&d||d&&!c){r=true;s=b.index||b.name;t=a}}});if(!i&&s||!1===
d.multipleSearch){var v="eq";0<=t&&n[t].searchoptions&&n[t].searchoptions.sopt?v=n[t].searchoptions.sopt[0]:d.sopt&&d.sopt.length&&(v=d.sopt[0]);i={groupOp:"AND",rules:[{field:s,op:v,data:""}]}}r=!1;d.tmplNames&&d.tmplNames.length&&(r=!0,p=d.tmplLabel,p+="<select class='ui-template'>",p+="<option value='default'>Default</option>",a.each(d.tmplNames,function(a,b){p=p+("<option value='"+a+"'>"+b+"</option>")}),p+="</select>");k="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+
c+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+k+"'>"+l+p+"</td><td class='EditButton' "+m+">"+q+o+"</td></tr></tbody></table>";c=a.jgrid.jqID(c);a("#"+c).jqFilter({columns:n,filter:d.loadDefaults?i:null,showQuery:d.showQuery,errorcheck:d.errorcheck,sopt:d.sopt,groupButton:d.multipleGroup,ruleButtons:d.multipleSearch,afterRedraw:d.afterRedraw,_gridsopt:a.jgrid.search.odata,ajaxSelectOptions:f.p.ajaxSelectOptions,
...
_savedData:{},processing:!1,onClose:null,ajaxEditOptions:{},serializeEditData:null,viewPagerButtons:!0},a.jgrid.edit,b||{});d[a(this)[0].p.id]=b;return this.each(function(){function f(){a(r+" > tbody > tr > td > .FormElement").each(function(){var b=a(".customelement",this);if(b.length){var d=a(b[0]).attr("name");a.each(l.p.colModel,function(){if(this.name===d&&this.editoptions&&a.isFunction(this.editoptions.custom_value)){try{if(u[d]=this.editoptions.custom_value.call(l,a("#"+a.jgrid.jqID(d),r),"get"),
void 0===u[d])throw"e1";}catch(b){"e1"===b?a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,jQuery.jgrid.edit.bClose):a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,b.message,jQuery.jgrid.edit.bClose)}return!0}})}else{switch(a(this).get(0).type){case "checkbox":a(this).is(":checked")?u[this.name]=a(this).val():(b=a(this).attr("offval"),u[this.name]=b);break;case "select-one":u[this.name]=a("option:selected",this).val();H[this.name]=a("option:selected",
this).text();break;case "select-multiple":u[this.name]=a(this).val();u[this.name]=u[this.name]?u[this.name].join(","):"";var c=[];a("option:selected",this).each(function(b,d){c[b]=a(d).text()});H[this.name]=c.join(",");break;case "password":case "text":case "textarea":case "button":u[this.name]=a(this).val()}l.p.autoencode&&(u[this.name]=a.jgrid.htmlEncode(u[this.name]))}});return!0}function c(b,c,e,f){var g,h,i,j=0,k,n,m,p=[],o=!1,s="",r;for(r=1;r<=f;r++)s+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";
"_empty"!=b&&(o=a(c).jqGrid("getInd",b));a(c.p.colModel).each(function(r){g=this.name;n=(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";if("cb"!==g&&"subgrid"!==g&&!0===this.editable&&"rn"!==g){if(!1===o)k="";else if(g==c.p.ExpandColumn&&!0===c.p.treeGrid)k=a("td[role='gridcell']:eq("+r+")",c.rows[o]).text();else{try{k=a.unformat.call(c,a("td[role='gridcell']:eq("+r+")",c.rows[o]),{rowId:b,colModel:this},r)}catch(q){k=this.edittype&&"textarea"==
this.edittype?a("td[role='gridcell']:eq("+r+")",c.rows[o]).text():a("td[role='gridcell']:eq("+r+")",c.rows[o]).html()}if(!k||"&nbsp;"==k||"&#160;"==k||1==k.length&&160==k.charCodeAt(0))k=""}var t=a.extend({},this.editoptions||{},{id:g,name:g}),x=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),v=parseInt(x.rowpos,10)||j+1,u=parseInt(2*(parseInt(x.colpos,10)||1),10);"_empty"==b&&t.defaultValue&&(k=a.isFunction(t.defaultValue)?t.defaultValue.call(l):t.defaultValue);
this.edittype||(this.edittype="text");l.p.autoencode&&(k=a.jgrid.htmlDecode(k));m=a.jgrid.createEl.call(l,this.edittype,t,k,!1,a.extend({},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||{}));""===k&&"checkbox"==this.edittype&&(k=a(m).attr("offval"));""===k&&"select"==this.edittype&&(k=a("option:eq(0)",m).text());if(d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate)d[l.p.id]._savedData[g]=k;a(m).addClass("FormElement");("text"==this.edittype||"textarea"==this.edittype)&&a(m).addClass("ui-widget-content ui-corner-all");
i=a(e).find("tr[rowpos="+v+"]");x.rowabove&&(t=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+x.rowcontent+"</td></tr>"),a(e).append(t),t[0].rp=v);0===i.length&&(i=a("<tr "+n+" rowpos='"+v+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(i).append(s),a(e).append(i),i[0].rp=v);a("td:eq("+(u-2)+")",i[0]).html("undefined"===typeof x.label?c.p.colNames[r]:x.label);a("td:eq("+(u-1)+")",i[0]).append(x.elmprefix).append(m).append(x.elmsuffix);p[j]=r;j++}});if(0<j&&(r=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+
(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+c.p.id+"_id' value='"+b+"'/></td></tr>"),r[0].rp=j+999,a(e).append(r),d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate))d[l.p.id]._savedData[c.p.id+"_id"]=b;return p}function h(b,c,e){var f,g=0,h,i,j,k,n;if(d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate)d[l.p.id]._savedData={},d[l.p.id]._savedData[c.p.id+"_id"]=b;var m=c.p.colModel;if("_empty"==b)a(m).each(function(){f=this.name;j=a.extend({},this.editoptions||{});
if((i=a("#"+a.jgrid.jqID(f),"#"+e))&&i.length&&null!==i[0])if(k="",j.defaultValue?(k=a.isFunction(j.defaultValue)?j.defaultValue.call(l):j.defaultValue,"checkbox"==i[0].type?(n=k.toLowerCase(),0>n.search(/(false|0|no|off|undefined)/i)&&""!==n?(i[0].checked=!0,i[0].defaultChecked=!0,i[0].value=k):(i[0].checked=!1,i[0].defaultChecked=!1)):i.val(k)):"checkbox"==i[0].type?(i[0].checked=!1,i[0].defaultChecked=!1,k=a(i).attr("offval")):i[0].type&&"select"==i[0].type.substr(0,6)?i[0].selectedIndex=0:i.val(k),
!0===d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate)d[l.p.id]._savedData[f]=k}),a("#id_g","#"+e).val(b);else{var p=a(c).jqGrid("getInd",b,!0);p&&(a('td[role="gridcell"]',p).each(function(i){f=m[i].name;if("cb"!==f&&"subgrid"!==f&&"rn"!==f&&!0===m[i].editable){if(f==c.p.ExpandColumn&&!0===c.p.treeGrid)h=a(this).text();else try{h=a.unformat.call(c,a(this),{rowId:b,colModel:m[i]},i)}catch(j){h="textarea"==m[i].edittype?a(this).text():a(this).html()}l.p.autoencode&&(h=a.jgrid.htmlDecode(h));if(!0===
d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate)d[l.p.id]._savedData[f]=h;f=a.jgrid.jqID(f);switch(m[i].edittype){case "password":case "text":case "button":case "image":case "textarea":if("&nbsp;"==h||"&#160;"==h||1==h.length&&160==h.charCodeAt(0))h="";a("#"+f,"#"+e).val(h);break;case "select":var k=h.split(","),k=a.map(k,function(b){return a.trim(b)});a("#"+f+" option","#"+e).each(function(){this.selected=!m[i].editoptions.multiple&&(a.trim(h)==a.trim(a(this).text())||k[0]==a.trim(a(this).text())||
k[0]==a.trim(a(this).val()))?!0:m[i].editoptions.multiple?-1<a.inArray(a.trim(a(this).text()),k)||-1<a.inArray(a.trim(a(this).val()),k)?!0:!1:!1});break;case "checkbox":h+="";m[i].editoptions&&m[i].editoptions.value?m[i].editoptions.value.split(":")[0]==h?(a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]("checked",!0),a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]("defaultChecked",!0)):(a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]("checked",!1),a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]("defaultChecked",!1)):(h=
h.toLowerCase(),0>h.search(/(false|0|no|off|undefined)/i)&&""!==h?(a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]("checked",!0),a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]("defaultChecked",!0)):(a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]("checked",!1),a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]("defaultChecked",!1)));break;case "custom":try{if(m[i].editoptions&&a.isFunction(m[i].editoptions.custom_value))m[i].editoptions.custom_value.call(l,a("#"+f,"#"+e),"set",h);else throw"e1";}catch(n){"e1"==n?a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,
"function 'custom_value' "+a.jgrid.edit.msg.nodefined,jQuery.jgrid.edit.bClose):a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,n.message,jQuery.jgrid.edit.bClose)}}g++}}),0<g&&a("#id_g",r).val(b))}}function g(){a.each(l.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&u.hasOwnProperty(b.name)&&""===u[b.name]&&(u[b.name]="null")})}function i(){var c,e=[!0,"",""],f={},i=l.p.prmNames,j,k,n,m,o,s=a(l).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+p),J]);s&&"object"===typeof s&&
(u=s);a.isFunction(d[l.p.id].beforeCheckValues)&&(s=d[l.p.id].beforeCheckValues.call(l,u,a("#"+p),"_empty"==u[l.p.id+"_id"]?i.addoper:i.editoper))&&"object"===typeof s&&(u=s);for(n in u)if(u.hasOwnProperty(n)&&(e=a.jgrid.checkValues.call(l,u[n],n,l),!1===e[0]))break;g();e[0]&&(f=a(l).triggerHandler("jqGridAddEditClickSubmit",[d[l.p.id],u,J]),void 0===f&&a.isFunction(d[l.p.id].onclickSubmit)&&(f=d[l.p.id].onclickSubmit.call(l,d[l.p.id],u)||{}),e=a(l).triggerHandler("jqGridAddEditBeforeSubmit",[u,a("#"+
p),J]),void 0===e&&(e=[!0,"",""]),e[0]&&a.isFunction(d[l.p.id].beforeSubmit)&&(e=d[l.p.id].beforeSubmit.call(l,u,a("#"+p))));if(e[0]&&!d[l.p.id].processing){d[l.p.id].processing=!0;a("#sData",r+"_2").addClass("ui-state-active");k=i.oper;j=i.id;u[k]="_empty"==a.trim(u[l.p.id+"_id"])?i.addoper:i.editoper;u[k]!=i.addoper?u[j]=u[l.p.id+"_id"]:void 0===u[j]&&(u[j]=u[l.p.id+"_id"]);delete u[l.p.id+"_id"];u=a.extend(u,d[l.p.id].editData,f);if(!0===l.p.treeGrid)for(o in u[k]==i.addoper&&(m=a(l).jqGrid("getGridParam",
"selrow"),u["adjacency"==l.p.treeGridModel?l.p.treeReader.parent_id_field:"parent_id"]=m),l.p.treeReader)l.p.treeReader.hasOwnProperty(o)&&(f=l.p.treeReader[o],u.hasOwnProperty(f)&&!(u[k]==i.addoper&&"parent_id_field"===o)&&delete u[f]);u[j]=a.jgrid.stripPref(l.p.idPrefix,u[j]);o=a.extend({url:d[l.p.id].url?d[l.p.id].url:a(l).jqGrid("getGridParam","editurl"),type:d[l.p.id].mtype,data:a.isFunction(d[l.p.id].serializeEditData)?d[l.p.id].serializeEditData.call(l,u):u,complete:function(f,g){u[j]=l.p.idPrefix+
u[j];if(g!="success"){e[0]=false;e[1]=a(l).triggerHandler("jqGridAddEditErrorTextFormat",[f,J]);e[1]=a.isFunction(d[l.p.id].errorTextFormat)?d[l.p.id].errorTextFormat.call(l,f):g+" Status: '"+f.statusText+"'. Error code: "+f.status}else{e=a(l).triggerHandler("jqGridAddEditAfterSubmit",[f,u,J]);e===void 0&&(e=[true,"",""]);e[0]&&a.isFunction(d[l.p.id].afterSubmit)&&(e=d[l.p.id].afterSubmit.call(l,f,u))}if(e[0]===false){a("#FormError>td",r).html(e[1]);a("#FormError",r).show()}else{a.each(l.p.colModel,
function(){if(H[this.name]&&this.formatter&&this.formatter=="select")try{delete H[this.name]}catch(a){}});u=a.extend(u,H);l.p.autoencode&&a.each(u,function(b,c){u[b]=a.jgrid.htmlDecode(c)});if(u[k]==i.addoper){e[2]||(e[2]=a.jgrid.randId());u[j]=e[2];if(d[l.p.id].closeAfterAdd){if(d[l.p.id].reloadAfterSubmit)a(l).trigger("reloadGrid");else if(l.p.treeGrid===true)a(l).jqGrid("addChildNode",e[2],m,u);else{a(l).jqGrid("addRowData",e[2],u,b.addedrow);a(l).jqGrid("setSelection",e[2])}a.jgrid.hideModal("#"+
a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose})}else if(d[l.p.id].clearAfterAdd){d[l.p.id].reloadAfterSubmit?a(l).trigger("reloadGrid"):l.p.treeGrid===true?a(l).jqGrid("addChildNode",e[2],m,u):a(l).jqGrid("addRowData",e[2],u,b.addedrow);h("_empty",l,p)}else d[l.p.id].reloadAfterSubmit?a(l).trigger("reloadGrid"):l.p.treeGrid===true?a(l).jqGrid("addChildNode",e[2],m,u):a(l).jqGrid("addRowData",e[2],u,b.addedrow)}else{if(d[l.p.id].reloadAfterSubmit){a(l).trigger("reloadGrid");
d[l.p.id].closeAfterEdit||setTimeout(function(){a(l).jqGrid("setSelection",u[j])},1E3)}else l.p.treeGrid===true?a(l).jqGrid("setTreeRow",u[j],u):a(l).jqGrid("setRowData",u[j],u);d[l.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose})}if(a.isFunction(d[l.p.id].afterComplete)){c=f;setTimeout(function(){a(l).triggerHandler("jqGridAddEditAfterComplete",[c,u,a("#"+p),J]);d[l.p.id].afterComplete.call(l,c,u,a("#"+p));
c=null},500)}if(d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate){a("#"+p).data("disabled",false);if(d[l.p.id]._savedData[l.p.id+"_id"]!="_empty")for(var n in d[l.p.id]._savedData)u[n]&&(d[l.p.id]._savedData[n]=u[n])}}d[l.p.id].processing=false;a("#sData",r+"_2").removeClass("ui-state-active");try{a(":input:visible","#"+p)[0].focus()}catch(o){}}},a.jgrid.ajaxOptions,d[l.p.id].ajaxEditOptions);!o.url&&!d[l.p.id].useDataProxy&&(a.isFunction(l.p.dataProxy)?d[l.p.id].useDataProxy=!0:(e[0]=!1,e[1]+=" "+
a.jgrid.errors.nourl));e[0]&&(d[l.p.id].useDataProxy?(f=l.p.dataProxy.call(l,o,"set_"+l.p.id),"undefined"==typeof f&&(f=[!0,""]),!1===f[0]?(e[0]=!1,e[1]=f[1]||"Error deleting the selected row!"):(o.data.oper==i.addoper&&d[l.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose}),o.data.oper==i.editoper&&d[l.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,
onClose:d[l.p.id].onClose}))):a.ajax(o))}!1===e[0]&&(a("#FormError>td",r).html(e[1]),a("#FormError",r).show())}function j(a,b){var c=!1,d;for(d in a)if(a[d]!=b[d]){c=!0;break}return c}function k(){var b=!0;a("#FormError",r).hide();if(d[l.p.id].checkOnUpdate&&(u={},H={},f(),N=a.extend({},u,H),Q=j(N,d[l.p.id]._savedData)))a("#"+p).data("disabled",!0),a(".confirm","#"+t.themodal).show(),b=!1;return b}function m(){if("_empty"!==e&&"undefined"!==typeof l.p.savedRow&&0<l.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(var b=
0;b<l.p.savedRow.length;b++)if(l.p.savedRow[b].id==e){a(l).jqGrid("restoreRow",e);break}}function n(b,c){0===b?a("#pData",r+"_2").addClass("ui-state-disabled"):a("#pData",r+"_2").removeClass("ui-state-disabled");b==c?a("#nData",r+"_2").addClass("ui-state-disabled"):a("#nData",r+"_2").removeClass("ui-state-disabled")}function o(){var b=a(l).jqGrid("getDataIDs"),c=a("#id_g",r).val();return[a.inArray(c,b),b]}var l=this;if(l.grid&&e){var q=l.p.id,p="FrmGrid_"+q,s="TblGrid_"+q,r="#"+a.jgrid.jqID(s),t=
{themodal:"editmod"+q,modalhead:"edithd"+q,modalcontent:"editcnt"+q,scrollelm:p},v=a.isFunction(d[l.p.id].beforeShowForm)?d[l.p.id].beforeShowForm:!1,E=a.isFunction(d[l.p.id].afterShowForm)?d[l.p.id].afterShowForm:!1,y=a.isFunction(d[l.p.id].beforeInitData)?d[l.p.id].beforeInitData:!1,x=a.isFunction(d[l.p.id].onInitializeForm)?d[l.p.id].onInitializeForm:!1,B=!0,A=1,F=0,u,H,N,Q,J,p=a.jgrid.jqID(p);"new"===e?(e="_empty",J="add",b.caption=d[l.p.id].addCaption):(b.caption=d[l.p.id].editCaption,J="edit");
!0===b.recreateForm&&void 0!==a("#"+a.jgrid.jqID(t.themodal))[0]&&a("#"+a.jgrid.jqID(t.themodal)).remove();var X=!0;b.checkOnUpdate&&b.jqModal&&!b.modal&&(X=!1);if(void 0!==a("#"+a.jgrid.jqID(t.themodal))[0]){B=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+a.jgrid.jqID(p)),J]);"undefined"==typeof B&&(B=!0);B&&y&&(B=y.call(l,a("#"+p)));if(!1===B)return;m();a(".ui-jqdialog-title","#"+a.jgrid.jqID(t.modalhead)).html(b.caption);a("#FormError",r).hide();d[l.p.id].topinfo?(a(".topinfo",r).html(d[l.p.id].topinfo),
a(".tinfo",r).show()):a(".tinfo",r).hide();d[l.p.id].bottominfo?(a(".bottominfo",r+"_2").html(d[l.p.id].bottominfo),a(".binfo",r+"_2").show()):a(".binfo",r+"_2").hide();h(e,l,p);"_empty"==e||!d[l.p.id].viewPagerButtons?a("#pData, #nData",r+"_2").hide():a("#pData, #nData",r+"_2").show();!0===d[l.p.id].processing&&(d[l.p.id].processing=!1,a("#sData",r+"_2").removeClass("ui-state-active"));!0===a("#"+p).data("disabled")&&(a(".confirm","#"+a.jgrid.jqID(t.themodal)).hide(),a("#"+p).data("disabled",!1));
a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+p),J]);v&&v.call(l,a("#"+p));a("#"+a.jgrid.jqID(t.themodal)).data("onClose",d[l.p.id].onClose);a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,jqM:!1,overlay:b.overlay,modal:b.modal});X||a(".jqmOverlay").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditAfterShowForm",
[a("#"+p),J]);E&&E.call(l,a("#"+p))}else{var Y=isNaN(b.dataheight)?b.dataheight:b.dataheight+"px",Y=a("<form name='FormPost' id='"+p+"' class='FormGrid' onSubmit='return false;' style='width:100%;overflow:auto;position:relative;height:"+Y+";'></form>").data("disabled",!1),V=a("<table id='"+s+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),B=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+p),J]);"undefined"==typeof B&&(B=!0);B&&y&&(B=y.call(l,a("#"+
p)));if(!1===B)return;m();a(l.p.colModel).each(function(){var a=this.formoptions;A=Math.max(A,a?a.colpos||0:0);F=Math.max(F,a?a.rowpos||0:0)});a(Y).append(V);y=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+2*A+"'></td></tr>");y[0].rp=0;a(V).append(y);y=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*A+"'>"+d[l.p.id].topinfo+"</td></tr>");y[0].rp=0;a(V).append(y);var B=(y="rtl"==l.p.direction?!0:!1)?"nData":"pData",W=y?"pData":"nData";c(e,
l,V,A);var B="<a href='javascript:void(0)' id='"+B+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",W="<a href='javascript:void(0)' id='"+W+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",aa="<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>"+b.bSubmit+"</a>",L="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+
b.bCancel+"</a>",s="<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"+s+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+(y?W+B:B+W)+"</td><td class='EditButton'>"+aa+L+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+d[l.p.id].bottominfo+"</td></tr>"),s=s+"</tbody></table>";if(0<F){var Z=[];a.each(a(V)[0].rows,function(a,b){Z[a]=b});Z.sort(function(a,
b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(Z,function(b,c){a("tbody",V).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(q);var S=!1;!0===b.closeOnEscape&&(b.closeOnEscape=!1,S=!0);s=a("<span></span>").append(Y).append(s);a.jgrid.createModal(t,s,b,"#gview_"+a.jgrid.jqID(l.p.id),a("#gbox_"+a.jgrid.jqID(l.p.id))[0]);y&&(a("#pData, #nData",r+"_2").css("float","right"),a(".EditButton",r+"_2").css("text-align","left"));d[l.p.id].topinfo&&a(".tinfo",r).show();d[l.p.id].bottominfo&&a(".binfo",r+"_2").show();
s=s=null;a("#"+a.jgrid.jqID(t.themodal)).keydown(function(c){var e=c.target;if(a("#"+p).data("disabled")===true)return false;if(d[l.p.id].savekey[0]===true&&c.which==d[l.p.id].savekey[1]&&e.tagName!="TEXTAREA"){a("#sData",r+"_2").trigger("click");return false}if(c.which===27){if(!k())return false;S&&a.jgrid.hideModal(this,{gb:b.gbox,jqm:b.jqModal,onClose:d[l.p.id].onClose});return false}if(d[l.p.id].navkeys[0]===true){if(a("#id_g",r).val()=="_empty")return true;if(c.which==d[l.p.id].navkeys[1]){a("#pData",
r+"_2").trigger("click");return false}if(c.which==d[l.p.id].navkeys[2]){a("#nData",r+"_2").trigger("click");return false}}});b.checkOnUpdate&&(a("a.ui-jqdialog-titlebar-close span","#"+a.jgrid.jqID(t.themodal)).removeClass("jqmClose"),a("a.ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(t.themodal)).unbind("click").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose});return false}));b.saveicon=a.extend([!0,
"left","ui-icon-disk"],b.saveicon);b.closeicon=a.extend([!0,"left","ui-icon-close"],b.closeicon);!0===b.saveicon[0]&&a("#sData",r+"_2").addClass("right"==b.saveicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.saveicon[2]+"'></span>");!0===b.closeicon[0]&&a("#cData",r+"_2").addClass("right"==b.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.closeicon[2]+"'></span>");if(d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate)aa=
...
(a.browser.msie&&6==a.browser.version?'<iframe style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>':"")+"</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(s+1)+"'>"+b.saveData+"<br/><br/>"+aa+W+L+"</div>").insertAfter("#"+p),a("#sNew","#"+a.jgrid.jqID(t.themodal)).click(function(){i();a("#"+p).data("disabled",false);a(".confirm","#"+a.jgrid.jqID(t.themodal)).hide();return false}),a("#nNew","#"+a.jgrid.jqID(t.themodal)).click(function(){a(".confirm",
"#"+a.jgrid.jqID(t.themodal)).hide();a("#"+p).data("disabled",false);setTimeout(function(){a(":input","#"+p)[0].focus()},0);return false}),a("#cNew","#"+a.jgrid.jqID(t.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(t.themodal)).hide();a("#"+p).data("disabled",false);a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditInitializeForm",[a("#"+p),J]);x&&x.call(l,a("#"+p));"_empty"==
e||!d[l.p.id].viewPagerButtons?a("#pData,#nData",r+"_2").hide():a("#pData,#nData",r+"_2").show();a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+p),J]);v&&v.call(l,a("#"+p));a("#"+a.jgrid.jqID(t.themodal)).data("onClose",d[l.p.id].onClose);a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,overlay:b.overlay,modal:b.modal});X||a(".jqmOverlay").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),
jqm:b.jqModal,onClose:d[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+p),J]);E&&E.call(l,a("#"+p));a(".fm-button","#"+a.jgrid.jqID(t.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",r+"_2").click(function(){u={};H={};a("#FormError",r).hide();f();if(u[l.p.id+"_id"]=="_empty")i();else if(b.checkOnSubmit===true){N=a.extend({},u,H);if(Q=j(N,d[l.p.id]._savedData)){a("#"+p).data("disabled",
true);a(".confirm","#"+a.jgrid.jqID(t.themodal)).show()}else i()}else i();return false});a("#cData",r+"_2").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose});return false});a("#nData",r+"_2").click(function(){if(!k())return false;a("#FormError",r).hide();var c=o();c[0]=parseInt(c[0],10);if(c[0]!=-1&&c[1][c[0]+1]){a(l).triggerHandler("jqGridAddEditClickPgButtons",["next",a("#"+p),c[1][c[0]]]);
var d=true;if(a.isFunction(b.onclickPgButtons)){d=b.onclickPgButtons.call(l,"next",a("#"+p),c[1][c[0]]);if(d!==void 0&&d===false)return false}if(a("#"+a.jgrid.jqID(c[1][c[0]+1])).hasClass("ui-state-disabled"))return false;h(c[1][c[0]+1],l,p);a(l).jqGrid("setSelection",c[1][c[0]+1]);a(l).triggerHandler("jqGridAddEditAfterClickPgButtons",["next",a("#"+p),c[1][c[0]]]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(l,"next",a("#"+p),c[1][c[0]+1]);n(c[0]+1,c[1].length-1)}return false});
a("#pData",r+"_2").click(function(){if(!k())return false;a("#FormError",r).hide();var c=o();if(c[0]!=-1&&c[1][c[0]-1]){a(l).triggerHandler("jqGridAddEditClickPgButtons",["prev",a("#"+p),c[1][c[0]]]);var d=true;if(a.isFunction(b.onclickPgButtons)){d=b.onclickPgButtons.call(l,"prev",a("#"+p),c[1][c[0]]);if(d!==void 0&&d===false)return false}if(a("#"+a.jgrid.jqID(c[1][c[0]-1])).hasClass("ui-state-disabled"))return false;h(c[1][c[0]-1],l,p);a(l).jqGrid("setSelection",c[1][c[0]-1]);a(l).triggerHandler("jqGridAddEditAfterClickPgButtons",
["prev",a("#"+p),c[1][c[0]]]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(l,"prev",a("#"+p),c[1][c[0]-1]);n(c[0]-1,c[1].length-1)}return false})}v=o();n(v[0],v[1].length-1)}})},viewGridRow:function(e,b){b=a.extend({top:0,left:0,width:0,height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,jqModal:!0,closeOnEscape:!1,labelswidth:"30%",closeicon:[],navkeys:[!1,38,40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0},a.jgrid.view,b||{});d[a(this)[0].p.id]=
b;return this.each(function(){function f(){(!0===d[j.p.id].closeOnEscape||!0===d[j.p.id].navkeys[0])&&setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(q.modalhead)).focus()},0)}function c(c,d,e,f){for(var g,h,i,j=0,l,k,n=[],m=!1,p="<td class='CaptionTD form-view-label ui-widget-content' width='"+b.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",o="",s=["integer","number","currency"],r=0,t=0,q,v,y,E=1;E<=f;E++)o+=1==E?
p:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(d.p.colModel).each(function(){h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1;!h&&"right"===this.align&&(this.formatter&&-1!==a.inArray(this.formatter,s)?r=Math.max(r,parseInt(this.width,10)):t=Math.max(t,parseInt(this.width,10)))});q=0!==r?r:0!==t?t:0;m=a(d).jqGrid("getInd",c);a(d.p.colModel).each(function(b){g=this.name;v=!1;k=(h=this.editrules&&
!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";y="boolean"!=typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&y){l=!1===m?"":g==d.p.ExpandColumn&&!0===d.p.treeGrid?a("td:eq("+b+")",d.rows[m]).text():a("td:eq("+b+")",d.rows[m]).html();v="right"===this.align&&0!==q?!0:!1;var c=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),p=parseInt(c.rowpos,10)||j+1,r=parseInt(2*(parseInt(c.colpos,10)||1),10);if(c.rowabove){var s=a("<tr><td class='contentinfo' colspan='"+
2*f+"'>"+c.rowcontent+"</td></tr>");a(e).append(s);s[0].rp=p}i=a(e).find("tr[rowpos="+p+"]");0===i.length&&(i=a("<tr "+k+" rowpos='"+p+"'></tr>").addClass("FormData").attr("id","trv_"+g),a(i).append(o),a(e).append(i),i[0].rp=p);a("td:eq("+(r-2)+")",i[0]).html("<b>"+("undefined"===typeof c.label?d.p.colNames[b]:c.label)+"</b>");a("td:eq("+(r-1)+")",i[0]).append("<span>"+l+"</span>").attr("id","v_"+g);v&&a("td:eq("+(r-1)+") span",i[0]).css({"text-align":"right",width:q+"px"});n[j]=b;j++}});0<j&&(c=
a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+c+"'/></td></tr>"),c[0].rp=j+99,a(e).append(c));return n}function h(b,c){var d,e,f=0,g,h;if(h=a(c).jqGrid("getInd",b,!0))a("td",h).each(function(b){d=c.p.colModel[b].name;e=c.p.colModel[b].editrules&&!0===c.p.colModel[b].editrules.edithidden?!1:!0===c.p.colModel[b].hidden?!0:!1;"cb"!==d&&"subgrid"!==d&&"rn"!==d&&(g=d==
c.p.ExpandColumn&&!0===c.p.treeGrid?a(this).text():a(this).html(),a.extend({},c.p.colModel[b].editoptions||{}),d=a.jgrid.jqID("v_"+d),a("#"+d+" span","#"+n).html(g),e&&a("#"+d,"#"+n).parents("tr:first").hide(),f++)}),0<f&&a("#id_g","#"+n).val(b)}function g(b,c){0===b?a("#pData","#"+n+"_2").addClass("ui-state-disabled"):a("#pData","#"+n+"_2").removeClass("ui-state-disabled");b==c?a("#nData","#"+n+"_2").addClass("ui-state-disabled"):a("#nData","#"+n+"_2").removeClass("ui-state-disabled")}function i(){var b=
a(j).jqGrid("getDataIDs"),c=a("#id_g","#"+n).val();return[a.inArray(c,b),b]}var j=this;if(j.grid&&e){var k=j.p.id,m="ViewGrid_"+a.jgrid.jqID(k),n="ViewTbl_"+a.jgrid.jqID(k),o="ViewGrid_"+k,l="ViewTbl_"+k,q={themodal:"viewmod"+k,modalhead:"viewhd"+k,modalcontent:"viewcnt"+k,scrollelm:m},p=a.isFunction(d[j.p.id].beforeInitData)?d[j.p.id].beforeInitData:!1,s=!0,r=1,t=0;if(void 0!==a("#"+a.jgrid.jqID(q.themodal))[0]){p&&(s=p.call(j,a("#"+m)),"undefined"==typeof s&&(s=!0));if(!1===s)return;a(".ui-jqdialog-title",
"#"+a.jgrid.jqID(q.modalhead)).html(b.caption);a("#FormError","#"+n).hide();h(e,j);a.isFunction(d[j.p.id].beforeShowForm)&&d[j.p.id].beforeShowForm.call(j,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(q.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:b.jqModal,jqM:!1,overlay:b.overlay,modal:b.modal});f()}else{var v=isNaN(b.dataheight)?b.dataheight:b.dataheight+"px",o=a("<form name='FormPost' id='"+o+"' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:"+v+";'></form>"),E=a("<table id='"+
l+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");p&&(s=p.call(j,a("#"+m)),"undefined"==typeof s&&(s=!0));if(!1===s)return;a(j.p.colModel).each(function(){var a=this.formoptions;r=Math.max(r,a?a.colpos||0:0);t=Math.max(t,a?a.rowpos||0:0)});a(o).append(E);c(e,j,E,r);l="rtl"==j.p.direction?!0:!1;p="<a href='javascript:void(0)' id='"+(l?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
s="<a href='javascript:void(0)' id='"+(l?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";v="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bClose+"</a>";if(0<t){var y=[];a.each(a(E)[0].rows,function(a,b){y[a]=b});y.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(y,function(b,c){a("tbody",E).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(k);o=a("<span></span>").append(o).append("<table border='0' class='EditTable' id='"+
n+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+b.labelswidth+"'>"+(l?s+p:p+s)+"</td><td class='EditButton'>"+v+"</td></tr></tbody></table>");a.jgrid.createModal(q,o,b,"#gview_"+a.jgrid.jqID(j.p.id),a("#gview_"+a.jgrid.jqID(j.p.id))[0]);l&&(a("#pData, #nData","#"+n+"_2").css("float","right"),a(".EditButton","#"+n+"_2").css("text-align","left"));b.viewPagerButtons||a("#pData, #nData","#"+n+"_2").hide();o=null;a("#"+q.themodal).keydown(function(c){if(c.which===27){d[j.p.id].closeOnEscape&&
a.jgrid.hideModal(this,{gb:b.gbox,jqm:b.jqModal,onClose:b.onClose});return false}if(b.navkeys[0]===true){if(c.which===b.navkeys[1]){a("#pData","#"+n+"_2").trigger("click");return false}if(c.which===b.navkeys[2]){a("#nData","#"+n+"_2").trigger("click");return false}}});b.closeicon=a.extend([!0,"left","ui-icon-close"],b.closeicon);!0===b.closeicon[0]&&a("#cData","#"+n+"_2").addClass("right"==b.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.closeicon[2]+"'></span>");
a.isFunction(b.beforeShowForm)&&b.beforeShowForm.call(j,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(q.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:b.jqModal,modal:b.modal});a(".fm-button:not(.ui-state-disabled)","#"+n+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});f();a("#cData","#"+n+"_2").click(function(){a.jgrid.hideModal("#"+a.jgrid.jqID(q.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:b.jqModal,onClose:b.onClose});return false});a("#nData",
"#"+n+"_2").click(function(){a("#FormError","#"+n).hide();var c=i();c[0]=parseInt(c[0],10);if(c[0]!=-1&&c[1][c[0]+1]){a.isFunction(b.onclickPgButtons)&&b.onclickPgButtons.call(j,"next",a("#"+m),c[1][c[0]]);h(c[1][c[0]+1],j);a(j).jqGrid("setSelection",c[1][c[0]+1]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(j,"next",a("#"+m),c[1][c[0]+1]);g(c[0]+1,c[1].length-1)}f();return false});a("#pData","#"+n+"_2").click(function(){a("#FormError","#"+n).hide();var c=i();if(c[0]!=-1&&c[1][c[0]-
1]){a.isFunction(b.onclickPgButtons)&&b.onclickPgButtons.call(j,"prev",a("#"+m),c[1][c[0]]);h(c[1][c[0]-1],j);a(j).jqGrid("setSelection",c[1][c[0]-1]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(j,"prev",a("#"+m),c[1][c[0]-1]);g(c[0]-1,c[1].length-1)}f();return false})}o=i();g(o[0],o[1].length-1)}})},delGridRow:function(e,b){b=a.extend({top:0,left:0,width:240,height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,url:"",mtype:"POST",reloadAfterSubmit:!0,beforeShowForm:null,
beforeInitData:null,afterShowForm:null,beforeSubmit:null,onclickSubmit:null,afterSubmit:null,jqModal:!0,closeOnEscape:!1,delData:{},delicon:[],cancelicon:[],onClose:null,ajaxDelOptions:{},processing:!1,serializeDelData:null,useDataProxy:!1},a.jgrid.del,b||{});d[a(this)[0].p.id]=b;return this.each(function(){var f=this;if(f.grid&&e){var c=a.isFunction(d[f.p.id].beforeShowForm),h=a.isFunction(d[f.p.id].afterShowForm),g=a.isFunction(d[f.p.id].beforeInitData)?d[f.p.id].beforeInitData:!1,i=f.p.id,j={},
k=!0,m="DelTbl_"+a.jgrid.jqID(i),n,o,l,q,p="DelTbl_"+i,s={themodal:"delmod"+i,modalhead:"delhd"+i,modalcontent:"delcnt"+i,scrollelm:m};jQuery.isArray(e)&&(e=e.join());if(void 0!==a("#"+a.jgrid.jqID(s.themodal))[0]){g&&(k=g.call(f,a("#"+m)),"undefined"==typeof k&&(k=!0));if(!1===k)return;a("#DelData>td","#"+m).text(e);a("#DelError","#"+m).hide();!0===d[f.p.id].processing&&(d[f.p.id].processing=!1,a("#dData","#"+m).removeClass("ui-state-active"));c&&d[f.p.id].beforeShowForm.call(f,a("#"+m));a.jgrid.viewModal("#"+
a.jgrid.jqID(s.themodal),{gbox:"#gbox_"+a.jgrid.jqID(i),jqm:d[f.p.id].jqModal,jqM:!1,overlay:d[f.p.id].overlay,modal:d[f.p.id].modal})}else{var r=isNaN(d[f.p.id].dataheight)?d[f.p.id].dataheight:d[f.p.id].dataheight+"px",p="<div id='"+p+"' class='formdata' style='width:100%;overflow:auto;position:relative;height:"+r+";'><table class='DelTable'><tbody><tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>"+("<tr id='DelData' style='display:none'><td >"+e+"</td></tr>"),p=p+('<tr><td class="delmsg" style="white-space:pre;">'+
d[f.p.id].msg+"</td></tr><tr><td >&#160;</td></tr>"),p=p+"</tbody></table></div>"+("<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='"+m+"_2'><tbody><tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>"+("<a href='javascript:void(0)' id='dData' class='fm-button ui-state-default ui-corner-all'>"+b.bSubmit+"</a>")+"&#160;"+("<a href='javascript:void(0)' id='eData' class='fm-button ui-state-default ui-corner-all'>"+b.bCancel+
"</a>")+"</td></tr></tbody></table>");b.gbox="#gbox_"+a.jgrid.jqID(i);a.jgrid.createModal(s,p,b,"#gview_"+a.jgrid.jqID(f.p.id),a("#gview_"+a.jgrid.jqID(f.p.id))[0]);g&&(k=g.call(f,a("#"+m)),"undefined"==typeof k&&(k=!0));if(!1===k)return;a(".fm-button","#"+m+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});b.delicon=a.extend([!0,"left","ui-icon-scissors"],d[f.p.id].delicon);b.cancelicon=a.extend([!0,"left","ui-icon-cancel"],d[f.p.id].cancelicon);
!0===b.delicon[0]&&a("#dData","#"+m+"_2").addClass("right"==b.delicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.delicon[2]+"'></span>");!0===b.cancelicon[0]&&a("#eData","#"+m+"_2").addClass("right"==b.cancelicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.cancelicon[2]+"'></span>");a("#dData","#"+m+"_2").click(function(){var c=[true,""];j={};var e=a("#DelData>td","#"+m).text();a.isFunction(d[f.p.id].onclickSubmit)&&(j=d[f.p.id].onclickSubmit.call(f,
d[f.p.id],e)||{});a.isFunction(d[f.p.id].beforeSubmit)&&(c=d[f.p.id].beforeSubmit.call(f,e));if(c[0]&&!d[f.p.id].processing){d[f.p.id].processing=true;l=f.p.prmNames;n=a.extend({},d[f.p.id].delData,j);q=l.oper;n[q]=l.deloper;o=l.id;e=(""+e).split(",");if(!e.length)return false;for(var g in e)e.hasOwnProperty(g)&&(e[g]=a.jgrid.stripPref(f.p.idPrefix,e[g]));n[o]=e.join();a(this).addClass("ui-state-active");g=a.extend({url:d[f.p.id].url?d[f.p.id].url:a(f).jqGrid("getGridParam","editurl"),type:d[f.p.id].mtype,
data:a.isFunction(d[f.p.id].serializeDelData)?d[f.p.id].serializeDelData.call(f,n):n,complete:function(g,h){if(h!="success"){c[0]=false;c[1]=a.isFunction(d[f.p.id].errorTextFormat)?d[f.p.id].errorTextFormat.call(f,g):h+" Status: '"+g.statusText+"'. Error code: "+g.status}else a.isFunction(d[f.p.id].afterSubmit)&&(c=d[f.p.id].afterSubmit.call(f,g,n));if(c[0]===false){a("#DelError>td","#"+m).html(c[1]);a("#DelError","#"+m).show()}else{if(d[f.p.id].reloadAfterSubmit&&f.p.datatype!="local")a(f).trigger("reloadGrid");
else{if(f.p.treeGrid===true)try{a(f).jqGrid("delTreeNode",f.p.idPrefix+e[0])}catch(j){}else for(var l=0;l<e.length;l++)a(f).jqGrid("delRowData",f.p.idPrefix+e[l]);f.p.selrow=null;f.p.selarrrow=[]}a.isFunction(d[f.p.id].afterComplete)&&setTimeout(function(){d[f.p.id].afterComplete.call(f,g,e)},500)}d[f.p.id].processing=false;a("#dData","#"+m+"_2").removeClass("ui-state-active");c[0]&&a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(i),jqm:b.jqModal,onClose:d[f.p.id].onClose})}},
a.jgrid.ajaxOptions,d[f.p.id].ajaxDelOptions);if(!g.url&&!d[f.p.id].useDataProxy)if(a.isFunction(f.p.dataProxy))d[f.p.id].useDataProxy=true;else{c[0]=false;c[1]=c[1]+(" "+a.jgrid.errors.nourl)}if(c[0])if(d[f.p.id].useDataProxy){g=f.p.dataProxy.call(f,g,"del_"+f.p.id);typeof g=="undefined"&&(g=[true,""]);if(g[0]===false){c[0]=false;c[1]=g[1]||"Error deleting the selected row!"}else a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(i),jqm:b.jqModal,onClose:d[f.p.id].onClose})}else a.ajax(g)}if(c[0]===
false){a("#DelError>td","#"+m).html(c[1]);a("#DelError","#"+m).show()}return false});a("#eData","#"+m+"_2").click(function(){a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(i),jqm:d[f.p.id].jqModal,onClose:d[f.p.id].onClose});return false});c&&d[f.p.id].beforeShowForm.call(f,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(s.themodal),{gbox:"#gbox_"+a.jgrid.jqID(i),jqm:d[f.p.id].jqModal,overlay:d[f.p.id].overlay,modal:d[f.p.id].modal})}h&&d[f.p.id].afterShowForm.call(f,a("#"+
m));!0===d[f.p.id].closeOnEscape&&setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(s.modalhead)).focus()},0)}})},navGrid:function(d,b,f,c,h,g,i){b=a.extend({edit:!0,editicon:"ui-icon-pencil",add:!0,addicon:"ui-icon-plus",del:!0,delicon:"ui-icon-trash",search:!0,searchicon:"ui-icon-search",refresh:!0,refreshicon:"ui-icon-refresh",refreshstate:"firstpage",view:!1,viewicon:"ui-icon-document",position:"left",closeOnEscape:!0,beforeRefresh:null,afterRefresh:null,cloneToTop:!1,alertwidth:200,
alertheight:"auto",alerttop:null,alertleft:null,alertzIndex:null},a.jgrid.nav,b||{});return this.each(function(){if(!this.nav){var j={themodal:"alertmod_"+this.p.id,modalhead:"alerthd_"+this.p.id,modalcontent:"alertcnt_"+this.p.id},k=this,m;if(k.grid&&"string"==typeof d){void 0===a("#"+j.themodal)[0]&&(!b.alerttop&&!b.alertleft&&("undefined"!=typeof window.innerWidth?(b.alertleft=window.innerWidth,b.alerttop=window.innerHeight):"undefined"!=typeof document.documentElement&&"undefined"!=typeof document.documentElement.clientWidth&&
0!==document.documentElement.clientWidth?(b.alertleft=document.documentElement.clientWidth,b.alerttop=document.documentElement.clientHeight):(b.alertleft=1024,b.alerttop=768),b.alertleft=b.alertleft/2-parseInt(b.alertwidth,10)/2,b.alerttop=b.alerttop/2-25),a.jgrid.createModal(j,"<div>"+b.alerttext+"</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>",{gbox:"#gbox_"+a.jgrid.jqID(k.p.id),jqModal:!0,drag:!0,resize:!0,caption:b.alertcap,top:b.alerttop,left:b.alertleft,width:b.alertwidth,
height:b.alertheight,closeOnEscape:b.closeOnEscape,zIndex:b.alertzIndex},"#gview_"+a.jgrid.jqID(k.p.id),a("#gbox_"+a.jgrid.jqID(k.p.id))[0],!0));var n=1;b.cloneToTop&&k.p.toppager&&(n=2);for(var o=0;o<n;o++){var l=a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),q,p;0===o?(q=d,p=k.p.id,q==k.p.toppager&&(p+="_top",n=1)):(q=k.p.toppager,p=k.p.id+"_top");"rtl"==k.p.direction&&a(l).attr("dir","rtl").css("float",
"right");b.add&&(c=c||{},m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+b.addicon+"'></span>"+b.addtext+"</div>"),a("tr",l).append(m),a(m,l).attr({title:b.addtitle||"",id:c.id||"add_"+p}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(b.addfunc)?b.addfunc.call(k):a(k).jqGrid("editGridRow","new",c));return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}),
m=null);b.edit&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),f=f||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+b.editicon+"'></span>"+b.edittext+"</div>"),a("tr",l).append(m),a(m,l).attr({title:b.edittitle||"",id:f.id||"edit_"+p}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c=k.p.selrow;if(c)a.isFunction(b.editfunc)?b.editfunc.call(k,c):a(k).jqGrid("editGridRow",c,f);else{a.jgrid.viewModal("#"+j.themodal,{gbox:"#gbox_"+a.jgrid.jqID(k.p.id),jqm:true});a("#jqg_alrt").focus()}}return false}).hover(function(){a(this).hasClass("ui-state-disabled")||
a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}),m=null);b.view&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),i=i||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+b.viewicon+"'></span>"+b.viewtext+"</div>"),a("tr",l).append(m),a(m,l).attr({title:b.viewtitle||"",id:i.id||"view_"+p}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c=k.p.selrow;if(c)a.isFunction(b.viewfunc)?b.viewfunc.call(k,c):a(k).jqGrid("viewGridRow",c,i);
else{a.jgrid.viewModal("#"+j.themodal,{gbox:"#gbox_"+a.jgrid.jqID(k.p.id),jqm:true});a("#jqg_alrt").focus()}}return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}),m=null);b.del&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),h=h||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+b.delicon+"'></span>"+b.deltext+"</div>"),a("tr",l).append(m),a(m,l).attr({title:b.deltitle||"",id:h.id||
"del_"+p}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c;if(k.p.multiselect){c=k.p.selarrrow;c.length===0&&(c=null)}else c=k.p.selrow;if(c)a.isFunction(b.delfunc)?b.delfunc.call(k,c):a(k).jqGrid("delGridRow",c,h);else{a.jgrid.viewModal("#"+j.themodal,{gbox:"#gbox_"+a.jgrid.jqID(k.p.id),jqm:true});a("#jqg_alrt").focus()}}return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}),m=
null);(b.add||b.edit||b.del||b.view)&&a("tr",l).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");b.search&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),g=g||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+b.searchicon+"'></span>"+b.searchtext+"</div>"),a("tr",l).append(m),a(m,l).attr({title:b.searchtitle||"",id:g.id||"search_"+p}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(b.searchfunc)?
b.searchfunc.call(k,g):a(k).jqGrid("searchGrid",g));return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}),g.showOnLoad&&!0===g.showOnLoad&&a(m,l).click(),m=null);b.refresh&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+b.refreshicon+"'></span>"+b.refreshtext+"</div>"),a("tr",l).append(m),a(m,l).attr({title:b.refreshtitle||"",id:"refresh_"+
p}).click(function(){if(!a(this).hasClass("ui-state-disabled")){a.isFunction(b.beforeRefresh)&&b.beforeRefresh.call(k);k.p.search=false;try{var c=k.p.id;k.p.postData.filters="";a("#fbox_"+a.jgrid.jqID(c)).jqFilter("resetFilter");a.isFunction(k.clearToolbar)&&k.clearToolbar.call(k,false)}catch(d){}switch(b.refreshstate){case "firstpage":a(k).trigger("reloadGrid",[{page:1}]);break;case "current":a(k).trigger("reloadGrid",[{current:true}])}a.isFunction(b.afterRefresh)&&b.afterRefresh.call(k)}return false}).hover(function(){a(this).hasClass("ui-state-disabled")||
a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}),m=null);m=a(".ui-jqgrid").css("font-size")||"11px";a("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+m+";visibility:hidden;' ></div>");m=a(l).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(q+"_"+b.position,q).append(l);k.p._nvtd&&(m>k.p._nvtd[0]&&(a(q+"_"+b.position,q).width(m),k.p._nvtd[0]=m),k.p._nvtd[1]=m);l=m=m=null;this.nav=!0}}}})},navButtonAdd:function(d,
...
b){b=a.extend({sepclass:"ui-separator",sepcontent:""},b||{});return this.each(function(){if(this.grid){"string"===typeof d&&0!==d.indexOf("#")&&(d="#"+a.jgrid.jqID(d));var f=a(".navtable",d)[0];if(f){var c="<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='"+b.sepclass+"'></span>"+b.sepcontent+"</td>";a("tr",f).append(c)}}})},GridToForm:function(d,b){return this.each(function(){var f=this;if(f.grid){var c=a(f).jqGrid("getRowData",d);if(c)for(var h in c)a("[name="+a.jgrid.jqID(h)+
"]",b).is("input:radio")||a("[name="+a.jgrid.jqID(h)+"]",b).is("input:checkbox")?a("[name="+a.jgrid.jqID(h)+"]",b).each(function(){if(a(this).val()==c[h])a(this)[f.p.useProp?"prop":"attr"]("checked",!0);else a(this)[f.p.useProp?"prop":"attr"]("checked",!1)}):a("[name="+a.jgrid.jqID(h)+"]",b).val(c[h])}})},FormToGrid:function(d,b,f,c){return this.each(function(){if(this.grid){f||(f="set");c||(c="first");var h=a(b).serializeArray(),g={};a.each(h,function(a,b){g[b.name]=b.value});"add"==f?a(this).jqGrid("addRowData",
d,g,c):"set"==f&&a(this).jqGrid("setRowData",d,g)}})}})})(jQuery);
...
a("select",this),d=[];o[n]=a(c).val();o[n]=o[n]?o[n].join(","):"";a("select option:selected",this).each(function(b,c){d[b]=a(c).text()});l[n]=d.join(",")}else o[n]=a("select option:selected",this).val(),l[n]=a("select option:selected",this).text();t.formatter&&"select"==t.formatter&&(l={});break;case "custom":try{if(t.editoptions&&a.isFunction(t.editoptions.custom_value)){if(o[n]=t.editoptions.custom_value.call(m,a(".customelement",this),"get"),void 0===o[n])throw"e2";}else throw"e1";}catch(e){"e1"==
e&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"==e?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}s=a.jgrid.checkValues(o[n],b,m);if(!1===s[0])return s[1]=o[n]+" "+s[1],!1;m.p.autoencode&&(o[n]=a.jgrid.htmlEncode(o[n]));"clientArray"!==j.url&&t.editoptions&&!0===t.editoptions.NullIfEmpty&&
""===o[n]&&(q[n]="null")}});if(!1===s[0]){try{var v=a.jgrid.findPos(a("#"+a.jgrid.jqID(d),m.grid.bDiv)[0]);a.jgrid.info_dialog(a.jgrid.errors.errcap,s[1],a.jgrid.edit.bClose,{left:v[0],top:v[1]})}catch(E){alert(s[1])}return k}var y,i=m.p.prmNames;y=i.oper;v=i.id;o&&(o[y]=i.editoper,o[v]=d,"undefined"==typeof m.p.inlineData&&(m.p.inlineData={}),o=a.extend({},o,m.p.inlineData,j.extraparam));if("clientArray"==j.url){o=a.extend({},o,l);m.p.autoencode&&a.each(o,function(b,c){o[b]=a.jgrid.htmlDecode(c)});
v=a(m).jqGrid("setRowData",d,o);a(r).attr("editable","0");for(i=0;i<m.p.savedRow.length;i++)if(m.p.savedRow[i].id==d){p=i;break}0<=p&&m.p.savedRow.splice(p,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[d,v,o,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,d,v,j);k=!0;a(r).unbind("keydown")}else a("#lui_"+a.jgrid.jqID(m.p.id)).show(),q=a.extend({},o,q),q[v]=a.jgrid.stripPref(m.p.idPrefix,q[v]),a.ajax(a.extend({url:j.url,data:a.isFunction(m.p.serializeRowData)?m.p.serializeRowData.call(m,
q):q,type:j.mtype,async:!1,complete:function(b,c){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();if(c==="success"){var e=true,f;f=a(m).triggerHandler("jqGridInlineSuccessSaveRow",[b,d,j]);a.isArray(f)||(f=[true,o]);f[0]&&a.isFunction(j.successfunc)&&(f=j.successfunc.call(m,b));if(a.isArray(f)){e=f[0];o=f[1]?f[1]:o}else e=f;if(e===true){m.p.autoencode&&a.each(o,function(b,c){o[b]=a.jgrid.htmlDecode(c)});o=a.extend({},o,l);a(m).jqGrid("setRowData",d,o);a(r).attr("editable","0");for(e=0;e<m.p.savedRow.length;e++)if(m.p.savedRow[e].id==
d){p=e;break}p>=0&&m.p.savedRow.splice(p,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[d,b,o,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,d,b);k=true;a(r).unbind("keydown")}else{a(m).triggerHandler("jqGridInlineErrorSaveRow",[d,b,c,null,j]);a.isFunction(j.errorfunc)&&j.errorfunc.call(m,d,b,c,null);j.restoreAfterError===true&&a(m).jqGrid("restoreRow",d,j.afterrestorefunc)}}},error:function(b,c,e){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();a(m).triggerHandler("jqGridInlineErrorSaveRow",
...
a(b.grid.bDiv)[0].clientHeight,h=a(b.grid.bDiv)[0].scrollTop,n=b.rows[c].offsetTop+b.rows[c].clientHeight,o=b.rows[c].offsetTop;"vd"==e&&n>=f&&(a(b.grid.bDiv)[0].scrollTop=a(b.grid.bDiv)[0].scrollTop+b.rows[c].clientHeight);"vu"==e&&o<h&&(a(b.grid.bDiv)[0].scrollTop=a(b.grid.bDiv)[0].scrollTop-b.rows[c].clientHeight)}"h"==e&&(e=a(b.grid.bDiv)[0].clientWidth,f=a(b.grid.bDiv)[0].scrollLeft,h=b.rows[c].cells[d].offsetLeft,b.rows[c].cells[d].offsetLeft+b.rows[c].cells[d].clientWidth>=e+parseInt(f,10)?
...
url:b.p.subGridUrl,dataType:b.p.subgridtype,data:a.isFunction(b.p.serializeSubGridData)?b.p.serializeSubGridData.call(b,f):f,complete:function(d){b.p.subgridtype==="xml"?c(d.responseXML,e):h(a.jgrid.parse(d.responseText),e)}},a.jgrid.ajaxOptions,b.p.ajaxSubgridOptions||{}))}return!1},i,j,k,m=0,n,o;a.each(b.p.colModel,function(){(!0===this.hidden||"rn"===this.name||"cb"===this.name)&&m++});var l=b.rows.length,q=1;void 0!==e&&0<e&&(q=e,l=e+1);for(;q<l;)a(b.rows[q]).hasClass("jqgrow")&&a(b.rows[q].cells[d]).bind("click",
function(){var c=a(this).parent("tr")[0];o=c.nextSibling;if(a(this).hasClass("sgcollapsed")){j=b.p.id;i=c.id;if(b.p.subGridOptions.reloadOnExpand===true||b.p.subGridOptions.reloadOnExpand===false&&!a(o).hasClass("ui-subgrid")){k=d>=1?"<td colspan='"+d+"'>&#160;</td>":"";n=a(b).triggerHandler("jqGridSubGridBeforeExpand",[j+"_"+i,i]);(n=n===false||n==="stop"?false:true)&&a.isFunction(b.p.subGridBeforeExpand)&&(n=b.p.subGridBeforeExpand.call(b,j+"_"+i,i));if(n===false)return false;a(c).after("<tr role='row' class='ui-subgrid'>"+
...
(function(a){a.jgrid.extend({setTreeNode:function(d,e){return this.each(function(){var b=this;if(b.grid&&b.p.treeGrid)for(var f=b.p.expColInd,c=b.p.treeReader.expanded_field,h=b.p.treeReader.leaf_field,g=b.p.treeReader.level_field,i=b.p.treeReader.icon_field,j=b.p.treeReader.loaded,k,m,n,o;d<e;)o=b.p.data[b.p._index[b.rows[d].id]],"nested"==b.p.treeGridModel&&!o[h]&&(k=parseInt(o[b.p.treeReader.left_field],10),m=parseInt(o[b.p.treeReader.right_field],10),o[h]=m===k+1?"true":"false",b.rows[d].cells[b.p._treeleafpos].innerHTML=
o[h]),k=parseInt(o[g],10),0===b.p.tree_root_level?(n=k+1,m=k):(n=k,m=k-1),n="<div class='tree-wrap tree-wrap-"+b.p.direction+"' style='width:"+18*n+"px;'>",n+="<div style='"+("rtl"==b.p.direction?"right:":"left:")+18*m+"px;' class='ui-icon ",void 0!==o[j]&&(o[j]="true"==o[j]||!0===o[j]?!0:!1),"true"==o[h]||!0===o[h]?(n+=(void 0!==o[i]&&""!==o[i]?o[i]:b.p.treeIcons.leaf)+" tree-leaf treeclick",o[h]=!0,m="leaf"):(o[h]=!1,m=""),o[c]=("true"==o[c]||!0===o[c]?!0:!1)&&o[j],n=!1===o[c]?n+(!0===o[h]?"'":
b.p.treeIcons.plus+" tree-plus treeclick'"):n+(!0===o[h]?"'":b.p.treeIcons.minus+" tree-minus treeclick'"),n+="></div></div>",a(b.rows[d].cells[f]).wrapInner("<span class='cell-wrapper"+m+"'></span>").prepend(n),k!==parseInt(b.p.tree_root_level,10)&&((o=(o=a(b).jqGrid("getNodeParent",o))&&o.hasOwnProperty(c)?o[c]:!0)||a(b.rows[d]).css("display","none")),a(b.rows[d].cells[f]).find("div.treeclick").bind("click",function(d){d=a(d.target||d.srcElement,b.rows).closest("tr.jqgrow")[0].id;d=b.p._index[d];
...
m=f.p.treeReader.loaded,n,o,l,q,p;n=0;var s=e,r;if("undefined"===typeof d||null===d){p=f.p.data.length-1;if(0<=p)for(;0<=p;)n=Math.max(n,parseInt(f.p.data[p][f.p.localReader.id],10)),p--;d=n+1}var t=a(f).jqGrid("getInd",e);r=!1;if(void 0===e||null===e||""===e)s=e=null,n="last",q=f.p.tree_root_level,p=f.p.data.length+1;else if(n="after",o=f.p._index[e],l=f.p.data[o],e=l[f.p.localReader.id],q=parseInt(l[g],10)+1,p=a(f).jqGrid("getFullTreeNode",l),p.length?(s=p=p[p.length-1][f.p.localReader.id],p=a(f).jqGrid("getInd",
s)+1):p=a(f).jqGrid("getInd",e)+1,l[h])r=!0,l[c]=!0,a(f.rows[t]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(f.p.treeIcons.leaf+" tree-leaf").addClass(f.p.treeIcons.minus+" tree-minus"),f.p.data[o][h]=!1,l[m]=!0;o=p+1;b[c]=!1;b[m]=!0;b[g]=q;b[h]=!0;"adjacency"===f.p.treeGridModel&&(b[i]=e);if("nested"===f.p.treeGridModel){var v;if(null!==e){h=parseInt(l[k],10);g=a.jgrid.from(f.p.data);g=g.greaterOrEquals(k,h,{stype:"integer"});
...
10)+2);b[j]=h+1;b[k]=h+2}}if(null===e||a(f).jqGrid("isNodeLoaded",l)||r)a(f).jqGrid("addRowData",d,b,n,s),a(f).jqGrid("setTreeNode",p,o);l&&!l[c]&&a(f.rows[t]).find("div.treeclick").click()}}})})(jQuery);
...
d-b)return c[a]}var f=this,c=f.p.groupingView,h="",g="",i,j,k=c.groupCollapse?c.plusicon:c.minusicon,m,n=[],o=c.groupField.length,k=k+(" tree-wrap-"+f.p.direction);a.each(f.p.colModel,function(a,b){for(var d=0;d<o;d++)if(c.groupField[d]===b.name){n[d]=a;break}});var l=0,q=a.makeArray(c.groupSummary);q.reverse();a.each(c.groups,function(p,s){l++;j=f.p.id+"ghead_"+s.idx;i=j+"_"+p;g="<span style='cursor:pointer;' class='ui-icon "+k+"' onclick=\"jQuery('#"+a.jgrid.jqID(f.p.id)+"').jqGrid('groupingToggle','"+
i+"');return false;\"></span>";try{m=f.formatter(i,s.value,n[s.idx],s.value)}catch(r){m=s.value}h+='<tr id="'+i+'" role="row" class= "ui-widget-content jqgroup ui-row-'+f.p.direction+" "+j+'"><td style="padding-left:'+12*s.idx+'px;" colspan="'+e+'">'+g+a.jgrid.template(c.groupText[s.idx],m,s.cnt,s.summary)+"</td></tr>";if(o-1===s.idx){for(var t=c.groups[p+1],v=void 0!==t?c.groups[p+1].startRow:d.length,E=s.startRow;E<v;E++)h+=d[E].join("");var y;if(void 0!==t){for(y=0;y<c.groupField.length&&t.dataIndex!==
c.groupField[y];y++);l=c.groupField.length-y}for(t=0;t<l;t++)if(q[t]){v="";c.groupCollapse&&!c.showSummaryOnHide&&(v=' style="display:none;"');h+="<tr"+v+' jqfootlevel="'+(s.idx-t)+'" role="row" class="ui-widget-content jqfoot ui-row-'+f.p.direction+'">';for(var v=b(p,t,c.groups),x=f.p.colModel,B,A=v.cnt,F=0;F<e;F++){var u="<td "+f.formatCol(F,1,"")+">&#160;</td>",H="{0}";a.each(v.summary,function(){if(this.nm===x[F].name){x[F].summaryTpl&&(H=x[F].summaryTpl);"string"===typeof this.st&&"avg"===this.st.toLowerCase()&&
this.v&&0<A&&(this.v/=A);try{B=f.formatter("",this.v,F,this)}catch(b){B=this.v}u="<td "+f.formatCol(F,1,"")+">"+a.jgrid.format(H,B)+"</td>";return!1}});h+=u}h+="</tr>"}l=y}});a("#"+a.jgrid.jqID(f.p.id)+" tbody:first").append(h);h=null})},groupingGroupBy:function(d,e){return this.each(function(){"string"===typeof d&&(d=[d]);var b=this.p.groupingView;this.p.grouping=!0;"undefined"===typeof b.visibiltyOnNextGrouping&&(b.visibiltyOnNextGrouping=[]);var f;for(f=0;f<b.groupField.length;f++)!b.groupColumnShow[f]&&
...
a(d.draggable).attr("id"),e=d.draggable.parent().parent().jqGrid("getRowData",e);if(!b.dropbyname){var k=0,m={},n,o=a("#"+a.jgrid.jqID(this.id)).jqGrid("getGridParam","colModel");try{for(var l in e){n=o[k].name;n=="cb"||n=="rn"||n=="subgrid"||e.hasOwnProperty(l)&&o[k]&&(m[n]=e[l]);k++}e=m}catch(q){}}d.helper.dropped=true;if(b.beforedrop&&a.isFunction(b.beforedrop)){n=b.beforedrop.call(this,c,d,e,a("#"+a.jgrid.jqID(f.p.id)),a(this));typeof n!="undefined"&&n!==null&&typeof n=="object"&&(e=n)}if(d.helper.dropped){var p;
if(b.autoid)if(a.isFunction(b.autoid))p=b.autoid.call(this,e);else{p=Math.ceil(Math.random()*1E3);p=b.autoidprefix+p}a("#"+a.jgrid.jqID(this.id)).jqGrid("addRowData",p,e,b.droppos)}b.ondrop&&a.isFunction(b.ondrop)&&b.ondrop.call(this,c,d,e)}}},b.drop_opts||{})},onstart:null,onstop:null,beforedrop:null,ondrop:null,drop_opts:{activeClass:"ui-state-active",hoverClass:"ui-state-hover"},drag_opts:{revert:"invalid",helper:"clone",cursor:"move",appendTo:"#jqgrid_dnd",zIndex:5E3},dragcopy:false,dropbyname:false,
